...
abbfile.write('module     p8_part1part21_part1part25part25_abbrevd'+diag+'h'+heli+'\n')
abbfile.write('   use p8_part1part21_part1part25part25_config, only: ki\n')
abbfile.write('   use p8_part1part21_part1part25part25_kinematics, only: epstensor\n')
abbfile.write('   use p8_part1part21_part1part25part25_globals'+'h'+heli+'\n')
...
abbfile.write('      use p8_part1part21_part1part25part25_config, only: deltaOS, &\n')
abbfile.write('     &    logfile, debug_nlo_diagrams\n')
abbfile.write('      use p8_part1part21_part1part25part25_kinematics\n')
abbfile.write('      use p8_part1part21_part1part25part25_model\n')
abbfile.write('      use p8_part1part21_part1part25part25_color, only: TR\n')
abbfile.write('      use p8_part1part21_part1part25part25_globalsl1, only: epspow\n')
abbfile.write('      implicit none\n')
abbfile.write('\n')
abb_chunks = []
line_counter = 0
...
abbfile.write('   end subroutine\n')
abbfile.write('end module p8_part1part21_part1part25part25_abbrevd'+diag+'h'+heli+'\n')



f90file.write('module     p8_part1part21_part1part25part25_'+diag_name+'\n')
f90file.write('   ! file: '+str(os.getcwd())+diag_name+'.f90 \n')
f90file.write('   ! generator: buildfortran.py \n')
f90file.write('   use p8_part1part21_part1part25part25_config, only: ki\n')
f90file.write('   use p8_part1part21_part1part25part25_util, only: cond\n')
f90file.write('\n')
...
f90file.write('      use p8_part1part21_part1part25part25_model\n')
f90file.write('      use p8_part1part21_part1part25part25_kinematics\n')
f90file.write('      use p8_part1part21_part1part25part25_color\n')
f90file.write('      use p8_part1part21_part1part25part25_abbrevd'+diag+'h'+heli+'\n')
f90file.write('      implicit none\n')
...
f90file.write('      use p8_part1part21_part1part25part25_globalsl1, only: epspow\n')
f90file.write('      use p8_part1part21_part1part25part25_kinematics\n')
f90file.write('      use p8_part1part21_part1part25part25_abbrevd'+diag+'h'+heli+'\n')
f90file.write('      implicit none\n')
f90file.write('\n')
...
f90file.write('   & bind(c, name="p8_part1part21_part1part25part25_'+diag_name+'_ninja")\n')
...
f90file.write('   !------#] subroutine numerator_ninja:\n')
f90file.write('!---#] numerator interfaces:\n')
f90file.write('end module p8_part1part21_part1part25part25_'+diag_name+'\n')
