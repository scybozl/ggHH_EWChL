module     p8_part1part21_part1part25part25_dipoles
   use p8_part1part21_part1part25part25_config, only: ki
   use p8_part1part21_part1part25part25_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T3, &
       & T2T3
   use p8_part1part21_part1part25part25_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
contains
   ...
   function I_ff_qed(mu_sq, vec, I, J)
      ...
      if (flag) then
              ...
              term = V_SING_QED(s_jk, real(0, ki), real(mdlMh, ki))
              term(1) = (term(1) + log_s * term(2) ) * ncs*(0.333333333333_ki)*(0.0_ki)/9.0_ki
              term(2) = term(2)* ncs*(0.333333333333_ki)*(0.0_ki)/9.0_ki
...
end module p8_part1part21_part1part25part25_dipoles
