module     p8_part1part21_part1part25part25_kinematics
   use p8_part1part21_part1part25part25_config, only: ki
   use p8_part1part21_part1part25part25_model
   use p8_part1part21_part1part25part25_scalar_cache
   implicit none
   save
...
!---#[ subroutine init_event:
   subroutine     init_event(vecs, hel2)
      use p8_part1part21_part1part25part25_config, only: debug_numpolvec, logfile
      use p8_part1part21_part1part25part25_model
      implicit none
...
!---#] functions dotproduct_XX:
   ...
   !---#] function epsom :
end module p8_part1part21_part1part25part25_kinematics
