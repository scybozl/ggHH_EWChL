...
\begin{picture}(140,120)(-10,-10)
   \ArrowLine(102.4,85.4)(58.3,72.5) % part1-propagator
   \Text(103.3,88.2)[lb]{$d(k_{1})$}
   \Gluon(117.1,34.5)(64.0,32.1){3}{11} % part21-propagator
   \Text(117.2,37.5)[lb]{$g(k_{2})$}
   \ArrowLine(58.3,72.5)(6.5,72.7) % part1-propagator
   \Text(6.5,75.7)[rb]{$d(k_{3})$}
   ...
   \Vertex(58.3,72.5){3} % part1-anti1-part21 vertex
...
% Diagram 2:
\begin{picture}(140,120)(-10,-10)
   \ArrowLine(102.4,85.4)(54.2,74.5) % part1-propagator
   \Text(103.1,88.3)[lb]{$d(k_{1})$}
   \Gluon(11.5,20.6)(47.9,40.1){3}{8} % part21-propagator
   \Text(10.0,18.0)[rt]{$g(k_{2})$}
   \ArrowLine(54.2,74.5)(6.5,72.7) % part1-propagator
   \Text(6.7,75.7)[rb]{$d(k_{3})$}
   ...
   \Vertex(54.2,74.5){3} % part1-anti1-part21 vertex
