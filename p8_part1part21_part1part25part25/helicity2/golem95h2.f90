module     p8_part1part21_part1part25part25_golem95h2
...
subroutine     reconstruct_group0(coeffs)
   ...
   use p8_part1part21_part1part25part25_groups, only: tensrec_info_group0
   use p8_part1part21_part1part25part25_d84h2l1, only: numerator_d84 => numerat&
   &or_golem95
   use p8_part1part21_part1part25part25_d84h2l1d, only: reconstruct_d84
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p8_part1part21_part1part25part25_d86h2l1, only: numerator_d86 => numerat&
   &or_golem95
   use p8_part1part21_part1part25part25_d86h2l1d, only: reconstruct_d86
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p8_part1part21_part1part25part25_d11h2l1, only: numerator_d11 => numerat&
   &or_golem95
   use p8_part1part21_part1part25part25_d11h2l1d, only: reconstruct_d11
   use p8_part1part21_part1part25part25_d88h2l1, only: numerator_d88 => numerat&
   &or_golem95
   use p8_part1part21_part1part25part25_d88h2l1d, only: reconstruct_d88
   implicit none
...
!---#] subroutine reconstruct_group2:
end module p8_part1part21_part1part25part25_golem95h2
