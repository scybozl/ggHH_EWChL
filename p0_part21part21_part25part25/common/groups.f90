module     p0_part21part21_part25part25_groups
...
function     contract_tensor_coefficients_group_0(coeffs) result(amp)
   ...
   use p0_part21part21_part25part25_config, only: debug_nlo_diagrams, logfile
   use p0_part21part21_part25part25_kinematics, only: k1, k2, k3, k4, es12, es3, es23, es4
...
!---#] subroutine ninja_exit:
end module p0_part21part21_part25part25_groups
