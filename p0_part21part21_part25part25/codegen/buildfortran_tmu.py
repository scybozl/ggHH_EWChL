...
f90file.write('module     p0_part21part21_part25part25_'+diag_name[:-1]+'21\n')
...
f90file.write('   use p0_part21part21_part25part25_util, only: cond_t, d => metric_tensor \n')
f90file.write('\n')
...
f90file.write('   & bind(c, name="p0_part21part21_part25part25_d{0}h{1}_ninja_tmu")\n'.format(diag,heli) )
f90file.write('      use iso_c_binding, only: c_int\n')
f90file.write('      use ninjago_module, only: ki => ki_nin\n')
f90file.write('      use p0_part21part21_part25part25_globalsl1, only: epspow \n')
f90file.write('      use p0_part21part21_part25part25_kinematics \n')
f90file.write('      use p0_part21part21_part25part25_abbrevd'+diag+'h'+heli+'\n')
f90file.write('      implicit none \n')
...
f90file.write('!---#] subroutine numerator_tmu: \n')
f90file.write('end module     p0_part21part21_part25part25_'+diag_name[:-1]+'21\n')
f90file.close()
