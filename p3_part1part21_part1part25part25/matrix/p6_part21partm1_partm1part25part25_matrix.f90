module p6_part21partm1_partm1part25part25_matrix
...
contains
   ...
   pure function prefactor()
      ...
      use p3_part1part21_part1part25part25_model, only: NC
      use p3_part1part21_part1part25part25_kinematics, only: &
      & in_helicities, symmetry_factor
      use p3_part1part21_part1part25part25_color, only: incolors
      implicit none
   ...
   subroutine     initgolem(is_first)
      use p3_part1part21_part1part25part25_matrix, only: orig_initgolem => initgolem
      implicit none
   ...
   subroutine     exitgolem(is_last)
      use p3_part1part21_part1part25part25_matrix, only: orig_exitgolem => exitgolem
      implicit none
   ...
   subroutine     samplitude(vecs, scale2, amp, prec, ok, h)
      use p3_part1part21_part1part25part25_matrix, only: orig_sub => samplitude
      implicit none
   ...
   function     samplitudel0(vecs, h) result(amp)
      use p3_part1part21_part1part25part25_matrix, only: orig_func => samplitudel0
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
   ...
   function     samplitudel1(vecs,scale2,ok,rat2,h) result(amp)
      use p3_part1part21_part1part25part25_matrix, only: orig_func => samplitudel1
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
   ...
   subroutine     ir_subtraction(vecs,scale2,amp)
      use p3_part1part21_part1part25part25_matrix, &
   ...
   subroutine OLP_color_correlated(vecs,ampcc)
      use p3_part1part21_part1part25part25_matrix, only: orig_func => OLP_color_correlated
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
   ...
   subroutine OLP_spin_correlated_lo2(vecs, ampsc)
      use p3_part1part21_part1part25part25_matrix, only: orig_func => OLP_spin_correlated_lo2
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
...
end module p6_part21partm1_partm1part25part25_matrix
