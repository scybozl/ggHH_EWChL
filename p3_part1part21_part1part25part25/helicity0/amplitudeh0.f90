module    p3_part1part21_part1part25part25_amplitudeh0
   use p3_part1part21_part1part25part25_config, only: ki, &
       & reduction_interoperation
   use p3_part1part21_part1part25part25_color, only: numcs
   use p3_part1part21_part1part25part25_groups
   use precision_golem, only: ki_gol => ki
   use p3_part1part21_part1part25part25_golem95h0
   use ninjago_module, only: ki_nin
   use p3_part1part21_part1part25part25_ninjah0
...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      use p3_part1part21_part1part25part25_util, only: square
      use p3_part1part21_part1part25part25_color, only: CF, CA
      use p3_part1part21_part1part25part25_kinematics, only: &
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
      use p3_part1part21_part1part25part25_config, only: include_eps_terms, include_eps2_terms, &
      & logfile, debug_nlo_diagrams
      use p3_part1part21_part1part25part25_globalsl1, only: col0,perm, use_perm, epspow
      use p3_part1part21_part1part25part25_globalsh0, &
     & only: init_lo, rat2
      use p3_part1part21_part1part25part25_abbrevd84h0, only: init_abbrevd84 => init_abbrev
      use p3_part1part21_part1part25part25_abbrevd86h0, only: init_abbrevd86 => init_abbrev
      use p3_part1part21_part1part25part25_abbrevd11h0, only: init_abbrevd11 => init_abbrev
      use p3_part1part21_part1part25part25_abbrevd88h0, only: init_abbrevd88 => init_abbrev
      use p3_part1part21_part1part25part25_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   use p3_part1part21_part1part25part25_config, only: &
      & logfile, debug_nlo_diagrams
   ...
   use p3_part1part21_part1part25part25_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p3_part1part21_part1part25part25_groups, only: contract_golem95
   use p3_part1part21_part1part25part25_ninjah0, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p3_part1part21_part1part25part25_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p3_part1part21_part1part25part25_groups, only: contract_golem95
   use p3_part1part21_part1part25part25_ninjah0, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p3_part1part21_part1part25part25_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p3_part1part21_part1part25part25_groups, only: contract_golem95
   use p3_part1part21_part1part25part25_ninjah0, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group2:
end module p3_part1part21_part1part25part25_amplitudeh0
