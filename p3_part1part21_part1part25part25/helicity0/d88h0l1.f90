module     p3_part1part21_part1part25part25_d88h0l1
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p3_part1part21_part1part25part25_d88h0l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p3_part1part21_part1part25part25_d88h0l1
