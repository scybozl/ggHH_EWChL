module    p3_part1part21_part1part25part25_amplitudeh2
   ...
   use p3_part1part21_part1part25part25_golem95h2
   use ninjago_module, only: ki_nin
   use p3_part1part21_part1part25part25_ninjah2
...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
     ...
     & only: init_lo, rat2
      use p3_part1part21_part1part25part25_abbrevd84h2, only: init_abbrevd84 => init_abbrev
      use p3_part1part21_part1part25part25_abbrevd86h2, only: init_abbrevd86 => init_abbrev
      use p3_part1part21_part1part25part25_abbrevd11h2, only: init_abbrevd11 => init_abbrev
      use p3_part1part21_part1part25part25_abbrevd88h2, only: init_abbrevd88 => init_abbrev
      use p3_part1part21_part1part25part25_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p3_part1part21_part1part25part25_golem95h2, only: reconstruct_golem95 => reconstruct_group
   use p3_part1part21_part1part25part25_groups, only: contract_golem95
   use p3_part1part21_part1part25part25_ninjah2, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p3_part1part21_part1part25part25_golem95h2, only: reconstruct_golem95 => reconstruct_group
   use p3_part1part21_part1part25part25_groups, only: contract_golem95
   use p3_part1part21_part1part25part25_ninjah2, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p3_part1part21_part1part25part25_golem95h2, only: reconstruct_golem95 => reconstruct_group
   use p3_part1part21_part1part25part25_groups, only: contract_golem95
   use p3_part1part21_part1part25part25_ninjah2, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group2:
end module p3_part1part21_part1part25part25_amplitudeh2
