...
f90file.write('module     p3_part1part21_part1part25part25_'+diag_name[:-1]+'32\n')
...
f90file.write('   & bind(c, name="p3_part1part21_part1part25part25_d{0}h{1}_ninja_t2")\n'.format(diag,heli) )
...
f90file.write('end module     p3_part1part21_part1part25part25_'+diag_name[:-1]+'32\n')
f90file.close()
