...
f90file.write('module     p3_part1part21_part1part25part25_diagramsh'+str(heli)+'l0\n')
f90file.write('   ! file: '+str(os.getcwd())+'diagramsl0.f90 \n')
f90file.write('   ! generator: buildfortranborn.py \n')
f90file.write('   use p3_part1part21_part1part25part25_color, only: numcs\n')
...
f90file.write('      use p3_part1part21_part1part25part25_config, only: debug_lo_diagrams, &\n')
f90file.write('        & use_sorted_sum\n')
f90file.write('      use p3_part1part21_part1part25part25_accu, only: sorted_sum\n')
f90file.write('      use p3_part1part21_part1part25part25_util, only: inspect_lo_diagram\n')
f90file.write('      implicit none\n')
...
f90file.write('!---#] function amplitude:\n')
f90file.write('end module p3_part1part21_part1part25part25_diagramsh'+str(heli)+'l0\n')
f90file.close()
