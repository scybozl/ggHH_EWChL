...
f90file.write('module     p2_part21part21_part21part25part25_'+diag_name[:-1]+'21\n')
...
f90file.write('   use p2_part21part21_part21part25part25_util, only: cond_t, d => metric_tensor \n')
f90file.write('\n')
...
f90file.write('   & bind(c, name="p2_part21part21_part21part25part25_d{0}h{1}_ninja_tmu")\n'.format(diag,heli) )
...
f90file.write('!---#] subroutine numerator_tmu: \n')
f90file.write('end module     p2_part21part21_part21part25part25_'+diag_name[:-1]+'21\n')
f90file.close()
