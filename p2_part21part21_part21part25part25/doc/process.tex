...
\begin{picture}(140,120)(-10,-10)
   \Gluon(102.4,85.4)(61.1,52.3){3}{11} % part21-propagator
   \Text(104.3,87.7)[lb]{$g(k_{1})$}
   \Gluon(117.1,34.5)(61.1,52.3){3}{12} % part21-propagator
   \Text(116.2,37.4)[lt]{$g(k_{2})$}
   \Gluon(61.1,52.3)(69.4,0.6){3}{10} % part21-propagator
   \Text(72.3,0.1)[lt]{$g(k_{3})$}
   \DashLine(61.1,52.3)(11.5,20.6){5} % part25-propagator
   \Text(13.1,23.1)[rt]{$h(k_{4})$}
   \DashLine(61.1,52.3)(6.5,72.7){5} % part25-propagator
   \Text(5.5,75.5)[rb]{$h(k_{5})$}
   \Vertex(61.1,52.3){3} % part21-part21-part21-part25-part25 vertex
\end{picture}
\\
{\sl Diagram~1}
\end{center}
...
% Diagram 2:
\begin{picture}(140,120)(-10,-10)
   \Gluon(102.4,85.4)(58.3,72.5){3}{9} % part21-propagator
   \Text(103.3,88.2)[lb]{$g(k_{1})$}
   \Gluon(6.5,72.7)(58.3,72.5){3}{10} % part21-propagator
   \Text(6.5,69.7)[rt]{$g(k_{2})$}
   \Gluon(64.0,32.1)(117.1,34.5){3}{11} % part21-propagator
   \Text(116.9,31.6)[lt]{$g(k_{3})$}
   \DashLine(64.0,32.1)(69.4,0.6){5} % part25-propagator
   \Text(72.3,0.1)[lt]{$h(k_{4})$}
   \DashLine(64.0,32.1)(11.5,20.6){5} % part25-propagator
   \Text(12.1,23.5)[rt]{$h(k_{5})$}
   \Vertex(58.3,72.5){3} % part21-part21-part21 vertex
   \Vertex(64.0,32.1){3} % part21-part21-part25-part25 vertex
   \Gluon(64.0,32.1)(58.3,72.5){3}{8} % part21-propagator
   \Text(58.2,51.9)[rt]{$g$}
\end{picture}
\\
{\sl Diagram~2}
...
\begin{picture}(140,120)(-10,-10)
   \Gluon(102.4,85.4)(58.3,72.5){3}{9} % part21-propagator
   \Text(103.3,88.2)[lb]{$g(k_{1})$}
   \Gluon(117.1,34.5)(64.0,32.1){3}{11} % part21-propagator
   \Text(117.2,37.5)[lb]{$g(k_{2})$}
   \Gluon(58.3,72.5)(6.5,72.7){3}{10} % part21-propagator
   \Text(6.5,75.7)[rb]{$g(k_{3})$}
   \DashLine(64.0,32.1)(69.4,0.6){5} % part25-propagator
   \Text(72.3,0.1)[lt]{$h(k_{4})$}
   \DashLine(64.0,32.1)(11.5,20.6){5} % part25-propagator
   \Text(12.1,23.5)[rt]{$h(k_{5})$}
...
\begin{picture}(140,120)(-10,-10)
   \Gluon(117.1,34.5)(64.0,32.1){3}{11} % part21-propagator
   \Text(117.2,37.5)[lb]{$g(k_{1})$}
   \Gluon(102.4,85.4)(58.3,72.5){3}{9} % part21-propagator
   \Text(103.3,88.2)[lb]{$g(k_{2})$}
   \Gluon(58.3,72.5)(6.5,72.7){3}{10} % part21-propagator
   \Text(6.5,75.7)[rb]{$g(k_{3})$}
   \DashLine(64.0,32.1)(69.4,0.6){5} % part25-propagator
   \Text(72.3,0.1)[lt]{$h(k_{4})$}
...
\begin{picture}(140,120)(-10,-10)
   \Gluon(117.1,34.5)(64.0,32.1){3}{11} % part21-propagator
   \Text(117.2,37.5)[lb]{$g(k_{1})$}
   \Gluon(69.4,0.6)(64.0,32.1){3}{6} % part21-propagator
   \Text(66.4,1.1)[rt]{$g(k_{2})$}
   \Gluon(64.0,32.1)(11.5,20.6){3}{11} % part21-propagator
   \Text(12.1,23.5)[rt]{$g(k_{3})$}
   \DashLine(58.3,72.5)(102.4,85.4){5} % part25-propagator
   \Text(101.6,82.5)[lb]{$h(k_{4})$}
   \DashLine(58.3,72.5)(6.5,72.7){5} % part25-propagator
   \Text(6.5,75.7)[rb]{$h(k_{5})$}
   \Vertex(58.3,72.5){3} % part25-part25-part25 vertex
   \Vertex(64.0,32.1){3} % part21-part21-part21-part25 vertex
   \DashLine(64.0,32.1)(58.3,72.5){5} % part25-propagator
   \Text(58.2,51.9)[rt]{$h$}
\end{picture}
\\
{\sl Diagram~5}
...
% Diagram 6:
\begin{picture}(140,120)(-10,-10)
   \Gluon(102.4,85.4)(54.2,74.5){3}{10} % part21-propagator
   \Text(103.1,88.3)[lb]{$g(k_{1})$}
   \Gluon(6.5,72.7)(54.2,74.5){3}{10} % part21-propagator
   \Text(6.4,69.7)[rt]{$g(k_{2})$}
   \Gluon(47.9,40.1)(11.5,20.6){3}{8} % part21-propagator
   \Text(12.9,23.3)[rt]{$g(k_{3})$}
   \DashLine(78.1,25.1)(117.1,34.5){5} % part25-propagator
   \Text(116.4,31.6)[lb]{$h(k_{4})$}
   \DashLine(78.1,25.1)(69.4,0.6){5} % part25-propagator
   \Text(72.2,1.6)[rt]{$h(k_{5})$}
   \Vertex(54.2,74.5){3} % part21-part21-part21 vertex
   \Vertex(78.1,25.1){3} % part25-part25-part25 vertex
   \Vertex(47.9,40.1){3} % part21-part21-part25 vertex
   \Gluon(47.9,40.1)(54.2,74.5){3}{7} % part21-propagator
   \Text(48.1,57.8)[rb]{$g$}
   \DashLine(47.9,40.1)(78.1,25.1){5} % part25-propagator
   \Text(64.4,35.3)[lb]{$h$}
\end{picture}
\\
{\sl Diagram~6}
...
\begin{picture}(140,120)(-10,-10)
   \Gluon(102.4,85.4)(54.2,74.5){3}{10} % part21-propagator
   \Text(103.1,88.3)[lb]{$g(k_{1})$}
   \Gluon(11.5,20.6)(47.9,40.1){3}{8} % part21-propagator
   \Text(10.0,18.0)[rt]{$g(k_{2})$}
   \Gluon(54.2,74.5)(6.5,72.7){3}{10} % part21-propagator
