module     p2_part21part21_part21part25part25_matrix
   ...
   use p2_part21part21_part21part25part25_model, only: Nf, NC, sqrt2, init_functions
   use p2_part21part21_part21part25part25_color, only: TR, CA, CF, numcs, &
     & incolors, init_color
   use p2_part21part21_part21part25part25_diagramsh0l0, only: amplitude0l0 => amplitude
   use p2_part21part21_part21part25part25_amplitudeh0, only: samplitudeh0l1 => samplitude, &
     &   finite_renormalisation0 => finite_renormalisation
   use p2_part21part21_part21part25part25_dipoles, only: insertion_operator, insertion_operator_qed
...
contains
      ...
      if(PSP_check) then
         ...
         if(icheck.eq.3.and.PSP_verbosity) then
            ...
            write(42,'(4x,A15,A34,A3)') &
                 &  "<process name='","p2_part21part21_part21part25part25","'/>"
   ...
   subroutine     samplitudel01(vecs, scale2, amp, rat2, ok, h)
      ...
      use p2_part21part21_part21part25part25_dipoles, only: pi
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
      real(ki), intent(in) :: scale2
      ...
      case default
         ! not implemented
         print*, "In p2_part21part21_part21part25part25_matrix:"
   ...
   function     samplitudel0(vecs, h) result(amp)
      use p2_part21part21_part21part25part25_config, only: logfile
      use p2_part21part21_part21part25part25_kinematics, only: init_event
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
   ...
   pure subroutine color_correlated_lo(color_vector,res)
      use p2_part21part21_part21part25part25_color, only: T1T1, &
      & T1T2, &
      & T1T3, &
      & T2T2, &
      & T2T3, &
   ...
   subroutine spin_correlated_lo2(vecs, bornsc)
      ...
      eps2 = spvak3k2/Spaa(k3,k2)/sqrt2
      eps3 = conjg(spvak2k3/Spaa(k2,k3)/sqrt2)
      !---#] Initialize polarization vectors :
      ...
      call construct_polarization_tensor(conjg(eps3),eps3,tens)
      bornsc(3,:,:) = bornsc(3,:,:) + real(tens(:,:) * pp, ki)
      call construct_polarization_tensor(conjg(eps3),conjg(eps3),tens)
      bornsc(3,:,:) = bornsc(3,:,:) + real(tens(:,:) * pm, ki)
      call construct_polarization_tensor(eps3,eps3,tens)
      bornsc(3,:,:) = bornsc(3,:,:) + real(tens(:,:) * mp, ki)
      call construct_polarization_tensor(eps3,conjg(eps3),tens)
      bornsc(3,:,:) = bornsc(3,:,:) + real(tens(:,:) * mm, ki)
      !---#] particle 3 :
   ...
   pure function square_0l_0l_sc(color_vector1, color_vector2) result(amp)
      use p2_part21part21_part21part25part25_color, only: cmat => CC
      implicit none
   ...
   pure function square_1_2_sc(color_vector1, color_vector2) result(amp)
      use p2_part21part21_part21part25part25_color, only: cmat => T1T2
   ...
   pure function square_1_3_sc(color_vector1, color_vector2) result(amp)
      use p2_part21part21_part21part25part25_color, only: cmat => T1T3
   ...
   pure function square_2_3_sc(color_vector1, color_vector2) result(amp)
      use p2_part21part21_part21part25part25_color, only: cmat => T2T3
...
end module p2_part21part21_part21part25part25_matrix
