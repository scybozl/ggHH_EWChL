module     p2_part21part21_part21part25part25_d149h0l131
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/p2_part21part21_part21p &
   ! &art25part25/helicity0d149h0l131.f90
...
!---#[ subroutine brack_31:
   pure subroutine brack_31(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      use p2_part21part21_part21part25part25_abbrevd149h0
      implicit none
      ...
      acd149(2)=dotproduct(ninjaE3,spvae3e1)
      acd149(3)=dotproduct(ninjaE3,spvae2e3)
      acd149(4)=abb149(7)
      acd149(5)=dotproduct(ninjaE3,spvae2e1)
      acd149(6)=dotproduct(ninjaE3,spvae1e3)
      acd149(7)=dotproduct(ninjaE3,spvae3e2)
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd149(1)=dotproduct(ninjaE3,spvae1e3)
      acd149(2)=dotproduct(ninjaE3,spvae3e2)
      acd149(3)=dotproduct(ninjaE4,spvae2e1)
      acd149(4)=abb149(7)
      acd149(5)=dotproduct(ninjaE3,spvae2e1)
      acd149(6)=dotproduct(ninjaE4,spvae3e2)
      acd149(7)=abb149(32)
      acd149(8)=dotproduct(ninjaE4,spvae1e3)
      acd149(9)=abb149(24)
      acd149(10)=dotproduct(ninjaE3,spvae2e3)
      acd149(11)=dotproduct(ninjaE3,spvae3e1)
      acd149(12)=dotproduct(ninjaE4,spvae1e2)
      acd149(13)=dotproduct(ninjaE3,spvae1e2)
      acd149(14)=dotproduct(ninjaE4,spvae3e1)
      acd149(15)=abb149(28)
      acd149(16)=dotproduct(ninjaE4,spvae2e3)
      acd149(17)=abb149(30)
      acd149(18)=dotproduct(ninjaA,ninjaE3)
      acd149(19)=dotproduct(ninjaA,spvae1e3)
      acd149(20)=dotproduct(ninjaA,spvae3e2)
      acd149(21)=dotproduct(ninjaA,spvae2e3)
      acd149(22)=dotproduct(ninjaA,spvae3e1)
      ...
      acd149(30)=abb149(26)
      acd149(31)=dotproduct(ninjaE3,spvak3e1)
      acd149(32)=abb149(34)
      acd149(33)=dotproduct(ninjaE3,spvae2k1)
      acd149(34)=abb149(8)
      acd149(35)=dotproduct(ninjaE3,spvae1k2)
      acd149(36)=abb149(23)
      acd149(37)=dotproduct(ninjaE3,spvae1k3)
      acd149(38)=abb149(29)
      acd149(39)=abb149(5)
      acd149(40)=abb149(6)
      acd149(41)=abb149(18)
      ...
      acd149(53)=dotproduct(ninjaA,spvak3e1)
      acd149(54)=dotproduct(ninjaA,spvae1k3)
      acd149(55)=abb149(25)
      acd149(56)=abb149(12)
      acd149(57)=abb149(10)
      acd149(58)=abb149(9)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p2_part21part21_part21part25part25_d149h0_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p2_part21part21_part21part25part25_d149h0l131
