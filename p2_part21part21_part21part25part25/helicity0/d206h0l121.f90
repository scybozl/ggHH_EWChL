module     p2_part21part21_part21part25part25_d206h0l121
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/p2_part21part21_part21p &
   ! &art25part25/helicity0d206h0l121.f90
...
!---#[ subroutine brack_0:
   pure subroutine brack_0(ninjaA0, brack)
      ...
      complex(ki), dimension(7) :: acd206
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd206(1)=dotproduct(ninjaA0,ninjaA0)
      acd206(2)=dotproduct(ninjaA0,spvae3e2)
      acd206(3)=abb206(101)
      acd206(4)=dotproduct(ninjaA0,spvae2e3)
      acd206(5)=abb206(103)
      acd206(6)=acd206(3)*acd206(2)
      acd206(7)=acd206(5)*acd206(4)
      acd206(6)=acd206(6)+acd206(7)
      acd206(6)=acd206(6)*acd206(1)**2
      brack(ninjaidxt0)=acd206(6)
   end subroutine brack_0
!---#] subroutine brack_0:
!---#[ subroutine numerator_tmu:
   subroutine numerator_tmu(ncut, a, coeffs) &
   & bind(c, name="p2_part21part21_part21part25part25_d206h0_ninja_tmu")
...
!---#] subroutine numerator_tmu:
end module     p2_part21part21_part21part25part25_d206h0l121
