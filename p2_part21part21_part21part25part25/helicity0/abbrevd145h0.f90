module     p2_part21part21_part21part25part25_abbrevd145h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      implicit none
      abb145(1)=1.0_ki/(-mdlMh**2+es45)
      abb145(2)=sqrt(mdlMT**2)
      abb145(3)=spbe2k1*spak1e3
      abb145(4)=spbk3e2*spae3k3
      abb145(5)=spak2e3*spbk2e2
      abb145(5)=abb145(3)+abb145(5)-abb145(4)
      abb145(5)=spbe3e1*spae1e2*abb145(5)
      abb145(6)=spae2k3*spbk3e3
      abb145(7)=spak1e2*spbe3k1
      abb145(6)=abb145(6)-abb145(7)
      abb145(7)=-spbe2e1*abb145(6)
      abb145(8)=spae2k2*spbe2e1
      abb145(9)=spbe3k2*abb145(8)
      abb145(7)=abb145(9)+abb145(7)
      abb145(7)=spae1e3*abb145(7)
      abb145(9)=spae2e3*spbe2e1
      abb145(10)=spae1k1*spbe3k1
      abb145(11)=abb145(10)*abb145(9)
      abb145(12)=spbk1e1*spak1e3
      abb145(13)=abb145(12)*spbe3e2
      ...
      abb145(14)=spbk3k2*spae3k3
      abb145(15)=-spbk2k1*spak1e3
      ...
      abb145(16)=spak2k3*spbk3e3
      abb145(17)=spak1k2*spbe3k1
      ...
      abb145(14)=-spbe3e1*abb145(11)*spae1e2
      abb145(17)=-spbe2e1*abb145(11)*spae1e3
      abb145(19)=abb145(11)*spbe3e2
      ...
      abb145(22)=spbe3e2*abb145(21)
      abb145(23)=abb145(7)*spae3k3
      abb145(24)=abb145(23)*spbk3k2
      abb145(25)=abb145(7)*spak1e3
      ...
      abb145(28)=-spak1e3*abb145(28)
      abb145(26)=-spak1e3*abb145(26)
      abb145(24)=spak1e3*abb145(24)
      abb145(12)=-spbe3k1*abb145(12)
      abb145(21)=-spbe3k1*abb145(21)
      abb145(4)=spbe3k1*abb145(4)
      R2d145=0.0_ki
      rat2 = rat2 + R2d145
...
end module p2_part21part21_part21part25part25_abbrevd145h0
