module     p1_part21part21_part25part25_model
   ! Model parameters for the model: /ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/GoS &
   ! &am_POWHEG/Virtual/model/model
   ...
   &000_ki)
   real(ki) :: mdlaEWM1 =      132.34077750000000_ki
!   real(ki) :: mdlaEWM1 =      132.3384324080000_ki
!   real(ki) :: mdlaEWM1 =      12.566370614000000000_ki
   real(ki),parameter :: mdlaS =        0.0795774715459400000_ki
   ...
   real(ki) :: mdlfloat4 =      125.000000000000000_ki
...
!---#] utility functions for model initialization:
end module p1_part21part21_part25part25_model
