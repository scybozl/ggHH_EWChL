module    p1_part21part21_part25part25_amplitudeh0
   use p1_part21part21_part25part25_config, only: ki, &
       & reduction_interoperation
   use p1_part21part21_part25part25_color, only: numcs
   use p1_part21part21_part25part25_groups
   use precision_golem, only: ki_gol => ki
   use p1_part21part21_part25part25_golem95h0
   use ninjago_module, only: ki_nin
   use p1_part21part21_part25part25_ninjah0
...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      use p1_part21part21_part25part25_util, only: square
      use p1_part21part21_part25part25_color, only: CF, CA
      use p1_part21part21_part25part25_kinematics, only: &
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
      use p1_part21part21_part25part25_config, only: include_eps_terms, include_eps2_terms, &
      & logfile, debug_nlo_diagrams
      use p1_part21part21_part25part25_globalsl1, only: col0,perm, use_perm, epspow
      use p1_part21part21_part25part25_globalsh0, &
     & only: init_lo, rat2
      use p1_part21part21_part25part25_abbrevd13h0, only: init_abbrevd13 => init_abbrev
      use p1_part21part21_part25part25_abbrevd2h0, only: init_abbrevd2 => init_abbrev
      use p1_part21part21_part25part25_abbrevd7h0, only: init_abbrevd7 => init_abbrev
      use p1_part21part21_part25part25_abbrevd11h0, only: init_abbrevd11 => init_abbrev
      use p1_part21part21_part25part25_abbrevd9h0, only: init_abbrevd9 => init_abbrev
      use p1_part21part21_part25part25_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   use p1_part21part21_part25part25_config, only: &
      & logfile, debug_nlo_diagrams
   ...
   use p1_part21part21_part25part25_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p1_part21part21_part25part25_groups, only: contract_golem95
   use p1_part21part21_part25part25_ninjah0, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p1_part21part21_part25part25_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p1_part21part21_part25part25_groups, only: contract_golem95
   use p1_part21part21_part25part25_ninjah0, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p1_part21part21_part25part25_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p1_part21part21_part25part25_groups, only: contract_golem95
   use p1_part21part21_part25part25_ninjah0, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group2:
end module p1_part21part21_part25part25_amplitudeh0
