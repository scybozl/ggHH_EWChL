program test
   use p0_part21part21_part25part25_config, only: ki, logfile, nlo_prefactors
   use p0_part21part21_part25part25_kinematics, only: dotproduct, boost_to_cms
   use p0_part21part21_part25part25_model, only: parse
   use p0_part21part21_part25part25_matrix, only: samplitude, &
     & initgolem, exitgolem, ir_subtraction
   use p0_part21part21_part25part25_color, only: numcs, CA
   use p0_part21part21_part25part25_rambo, only: ramb
...
subroutine  print_parameters(scale2)
   use p0_part21part21_part25part25_config, only: renormalisation, &
