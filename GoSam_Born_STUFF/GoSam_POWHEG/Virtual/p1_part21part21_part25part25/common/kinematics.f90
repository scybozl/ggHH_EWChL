module     p1_part21part21_part25part25_kinematics
   use p1_part21part21_part25part25_config, only: ki
   use p1_part21part21_part25part25_model
   use p1_part21part21_part25part25_scalar_cache
   implicit none
   save
...
!---#[ subroutine init_event:
   subroutine     init_event(vecs, hel1, hel2)
      use p1_part21part21_part25part25_config, only: debug_numpolvec, logfile
      use p1_part21part21_part25part25_model
      implicit none
...
!---#] functions dotproduct_XX:
   ...
   !---#] function epsom :
end module p1_part21part21_part25part25_kinematics
