...
CFLAGS="-I${PWD}"
FCFLAGS="${CFLAGS} \
 `sh ${PWD}/p1_part21part21_part25part25/config.sh -cflags` \
 `sh ${PWD}/p0_part21part21_part25part25/config.sh -pcflags`"
LDFLAGS="${PWD}/olp_module.o \
 `sh ${PWD}/p1_part21part21_part25part25/config.sh -libs` \
 `sh ${PWD}/p0_part21part21_part25part25/config.sh -plibs`"



FC=`sh ${PWD}/p1_part21part21_part25part25/config.sh -fortcom`
OLIBS=`sh ${PWD}/p1_part21part21_part25part25/config.sh -olibs`
OCFLAGS=`sh ${PWD}/p1_part21part21_part25part25/config.sh -ocflags`
