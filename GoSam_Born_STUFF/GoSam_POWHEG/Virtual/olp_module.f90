...
contains
   ...
   & bind(C,name="olp_start_")
      ...
      ! p0_part21part21_part25part25_PSP_chk_kfactor = PSP_chk_kfactor
      if(stage.lt.0) then
         call p1_part21part21_part25part25_initgolem(.true.)
         call p0_part21part21_part25part25_initgolem(.false.)
      else
         call p1_part21part21_part25part25_initgolem(.true.,stage,rndseed)
   ...
   use p1_part21part21_part25part25_version, only: gosamversion, gosamrevision
   ...
   subroutine OLP_Polvec(p,q,eps) &
      ...
      use p1_part21part21_part25part25_kinematics, only: Spab3, Spaa   
      implicit none
