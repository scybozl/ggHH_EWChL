module     p1_part21part21_part21part25part25_matrix
   ...
   use p1_part21part21_part21part25part25_model, only: Nf, NC, sqrt2, init_functions
   use p1_part21part21_part21part25part25_color, only: TR, CA, CF, numcs, &
     & incolors, init_color
   use p1_part21part21_part21part25part25_amplitudeh0, only: samplitudeh0l1 => samplitude, &
     &   finite_renormalisation0 => finite_renormalisation
   use p1_part21part21_part21part25part25_dipoles, only: insertion_operator, insertion_operator_qed
...
contains
      ...
      if(PSP_check) then
         ...
         if(icheck.eq.3.and.PSP_verbosity) then
            ...
            write(42,'(4x,A15,A34,A3)') &
                 &  "<process name='","p1_part21part21_part21part25part25","'/>"
   ...
   subroutine     samplitudel01(vecs, scale2, amp, rat2, ok, h)
      ...
      use p1_part21part21_part21part25part25_dipoles, only: pi
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
      real(ki), intent(in) :: scale2
      ...
      case default
         ! not implemented
         print*, "In p1_part21part21_part21part25part25_matrix:"
   ...
   function     samplitudel0(vecs, h) result(amp)
      use p1_part21part21_part21part25part25_config, only: logfile
      use p1_part21part21_part21part25part25_kinematics, only: init_event
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
   ...
   pure subroutine color_correlated_lo(color_vector,res)
      use p1_part21part21_part21part25part25_color, only: T1T1, &
      & T1T2, &
      & T1T3, &
      & T2T2, &
      & T2T3, &
...
!      color_vector = amplitude0l0()
   ...
   pure function square_0l_0l_sc(color_vector1, color_vector2) result(amp)
      use p1_part21part21_part21part25part25_color, only: cmat => CC
      implicit none
   ...
   pure function square_1_2_sc(color_vector1, color_vector2) result(amp)
      use p1_part21part21_part21part25part25_color, only: cmat => T1T2
   ...
   pure function square_1_3_sc(color_vector1, color_vector2) result(amp)
      use p1_part21part21_part21part25part25_color, only: cmat => T1T3
   ...
   pure function square_2_3_sc(color_vector1, color_vector2) result(amp)
      use p1_part21part21_part21part25part25_color, only: cmat => T2T3
...
end module p1_part21part21_part21part25part25_matrix
