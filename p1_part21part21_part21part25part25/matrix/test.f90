program test
   use p1_part21part21_part21part25part25_config, only: ki, logfile, nlo_prefactors
   use p1_part21part21_part21part25part25_kinematics, only: dotproduct, boost_to_cms
   use p1_part21part21_part21part25part25_model, only: parse
   use p1_part21part21_part21part25part25_matrix, only: samplitude, &
     & initgolem, exitgolem, ir_subtraction
   use p1_part21part21_part21part25part25_color, only: numcs, CA
   use p1_part21part21_part21part25part25_rambo, only: ramb
...
subroutine  print_parameters(scale2)
   use p1_part21part21_part21part25part25_config, only: renormalisation, &
