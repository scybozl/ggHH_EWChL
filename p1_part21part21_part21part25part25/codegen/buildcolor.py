...
colorfile.write('module     p1_part21part21_part21part25part25_color\n')
colorfile.write('   ! file: '+str(os.getcwd())+'/color.f90 \n')
colorfile.write('   ! generator: buildcolor.py\n')
colorfile.write('   use p1_part21part21_part21part25part25_config, only: ki\n')
colorfile.write('   use p1_part21part21_part21part25part25_model, only: NC, Nf\n')
...
colorfile.write('\n')
colorfile.write('   integer, parameter, public :: numcs = 2\n')
for item in gc:
...
colorfile.write('/)\n')
colorfile.write('   real(ki), dimension(numcs), parameter, public :: c2 = &\n')
colorfile.write('      & (/')
colorfile.write('         0.0_ki, ')
colorfile.write('         1.0_ki')
colorfile.write('/)\n')
...
colorfile.write('end module p1_part21part21_part21part25part25_color\n')
