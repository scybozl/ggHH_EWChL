...
modelfile.write('module     p1_part21part21_part21part25part25_model\n')
modelfile.write('   ! Model parameters for the model: FeynRules,/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/EWChL_UFO\n')
modelfile.write('   use p1_part21part21_part21part25part25_config, only: ki')
modelfile.write(', &\n')
...
modelfile.write('   complex(ki) :: gauge3z = (       0.000000000000000_ki,        0.000000000000000_ki)\n')
...
modelfile.write('   real(ki),parameter :: mdlMe =        0.000000000000000_ki\n')
...
modelfile.write('   real(ki),parameter :: mdlymb =        0.000000000000000_ki\n')
...
modelfile.write('   character(len=name_length), dimension(32) :: names = (/&\n')
...
modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\")') \"#\", \"gauge3z= \", gauge3z\n")
...
modelfile.write("   write(unit,'(A1,1x,A11,G23.16,\"const.\")') \"#\", \"mdlMe= \", mdlMe\n")
...
modelfile.write("   write(unit,'(A1,1x,A11,G23.16,\"const.\")') \"#\", \"mdlymb= \", mdlymb\n")
...
modelfile.write("end module p1_part21part21_part21part25part25_model\n")
