...
Symbols
      ...
      [field.part251],[field.anti251],[field.part25];
*---#] Fields:
*---#[ Parameters:
Symbols
...
Identify Once vertex(iv?,
   [field.part25], idx1?,0,vec1?,idx1L0?,1,idx1C1?,
   [field.part25], idx2?,0,vec2?,idx2L0?,1,idx2C1?,
   [field.part25], idx3?,0,vec3?,idx3L0?,1,idx3C1?,
   [field.part25], idx4?,0,vec4?,idx4L0?,1,idx4C1?) =
   + mdlGC9;
Sum MDLIndex1;
*---#] (V_1) h -- h -- h -- h Vertex:
*---#[ (V_2) h -- h -- h Vertex:
...
Identify Once vertex(iv?,
   ...
   [field.part21], idx3?,2,vec3?,idx3L2?,8,idx3C8?,
   [field.part21], idx4?,2,vec4?,idx4L2?,8,idx4C8?,
   [field.part25], idx5?,0,vec5?,idx5L0?,1,idx5C1?) =
   + mdlGC40 * (
      f(MDLIndex1,idx1C8,idx2C8)*f(idx3C8,idx4C8,MDLIndex1)*(d(idx1L2,
      idx4L2)*d(idx2L2,idx3L2)-d(idx1L2,idx3L2)*d(idx2L2,idx4L2))
   )
...
Identify Once vertex(iv?,
   ...
   [field.part21], idx4?,2,vec4?,idx4L2?,8,idx4C8?,
   [field.part25], idx5?,0,vec5?,idx5L0?,1,idx5C1?,
   [field.part25], idx6?,0,vec6?,idx6L0?,1,idx6C1?) =
   + mdlGC33 * (
      f(MDLIndex1,idx1C8,idx2C8)*f(idx3C8,idx4C8,MDLIndex1)*(d(idx1L2,
      idx4L2)*d(idx2L2,idx3L2)-d(idx1L2,idx3L2)*d(idx2L2,idx4L2))
   )
