module     p1_part21part21_part21part25part25_dipoles
   use p1_part21part21_part21part25part25_config, only: ki
   use p1_part21part21_part21part25part25_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T3, &
       & T2T3
   use p1_part21part21_part21part25part25_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p1_part21part21_part21part25part25_dipoles
