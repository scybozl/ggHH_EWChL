module     p1_part21part21_part21part25part25_groups
...
function     contract_tensor_coefficients_group_0(coeffs) result(amp)
   ...
   use p1_part21part21_part21part25part25_config, only: debug_nlo_diagrams, logfile
   use p1_part21part21_part21part25part25_kinematics, only: k1, k2, k3, k4, k5, es45, es12, es51, es23, es5, es4, es34
...
!---#] subroutine ninja_exit:
end module p1_part21part21_part21part25part25_groups
