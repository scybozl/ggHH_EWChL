module     pb_part21part21_part25part25_matrix
...
contains
   ...
   subroutine     samplitudel01(vecs, scale2, amp, rat2, ok, h)
      ...
      use pb_part21part21_part25part25_dipoles, only: pi
      implicit none
      real(ki), dimension(4, 4), intent(in) :: vecs
      real(ki), intent(in) :: scale2
      ...
      case default
         ! not implemented
         print*, "In pb_part21part21_part25part25_matrix:"
   ...
   function     samplitudel0(vecs, h) result(amp)
      use pb_part21part21_part25part25_config, only: logfile
      use pb_part21part21_part25part25_kinematics, only: init_event
      implicit none
      real(ki), dimension(4, 4), intent(in) :: vecs
   ...
   pure subroutine color_correlated_lo(color_vector,res)
      use pb_part21part21_part25part25_color, only: T1T1, &
      & T1T2, &
      & T2T2
      implicit none
   ...
   pure function square_0l_0l_sc(color_vector1, color_vector2) result(amp)
      use pb_part21part21_part25part25_color, only: cmat => CC
      implicit none
   ...
   pure function square_1_2_sc(color_vector1, color_vector2) result(amp)
      use pb_part21part21_part25part25_color, only: cmat => T1T2
...
end module pb_part21part21_part25part25_matrix
