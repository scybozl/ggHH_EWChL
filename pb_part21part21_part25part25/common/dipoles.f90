module     pb_part21part21_part25part25_dipoles
   use pb_part21part21_part25part25_config, only: ki
   use pb_part21part21_part25part25_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2
   use pb_part21part21_part25part25_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module pb_part21part21_part25part25_dipoles
