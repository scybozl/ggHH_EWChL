...
%(Further they do not cite us, only the NNLO$_{FTapprox}$ paper with Grazzini et al, but in the context of single Higgs production (!?), but of course it is our fault that we did not rectify this, so this is not an argument here.)
...
%Li:2019uyy,Corbett:2017ieo: do not cite us either, the analysis is based entirely on LO studies
\end{itemize}
\end{itemize}
