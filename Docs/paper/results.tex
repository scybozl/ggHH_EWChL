...
We compare the \pythia~\cite{Sjostrand:2014zea} and \herwig~\cite{Bellm:2017bvx} parton showers combined with the \powheg{} LHE events.
In the \herwig case, we also compare the default shower (angular ordered) with the Dipole shower.
In addition we assess the uncertainties stemming from the matching and show results where the \herwig{} {\tt HardScale} is varied.
