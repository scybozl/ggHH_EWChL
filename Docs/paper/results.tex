...
\caption{Higgs boson pair invariant mass distributions for non-SM values of the top quark Yukawa coupling $y_t$  at $\sqrt{s}=14$\,TeV, including scale uncertainties.
\label{fig:ytvar_mhh}}
\end{figure}
Fig.~\ref{fig:ytvar_mhh} demonstrates the effect of variations of the top quark Yukawa coupling $y_t$ on the $\mhh$ distribution, where $\chhh$ is fixed to the SM value.
...
While both \herw showers give very similar results and turn back to the fixed-order calculation at high-$\pthh$, the 
...
quark pair production~\cite{Ravasio:2018lzi}.
