module     p1_part21part21_part25part25_d11h0l1
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/GoSam_POWHEG/Virtual/p1 &
   ! &_part21part21_part25part25/helicity0d11h0l1.f90
   ! generator: buildfortran.py
   use p1_part21part21_part25part25_config, only: ki
   use p1_part21part21_part25part25_util, only: cond
   implicit none
   private
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p1_part21part21_part25part25_d11h0l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p1_part21part21_part25part25_d11h0l1
