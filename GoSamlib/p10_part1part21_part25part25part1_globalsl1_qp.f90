module     p10_part1part21_part25part25part1_globalsl1_qp
...
contains
   ...
   pure function ccontract_cc(color_vector1, color_vector2) result(amp)
      use p10_part1part21_part25part25part1_color_qp, only: cmat => CC
      implicit none
   ...
   !---#] function ccontract_rc:
end module p10_part1part21_part25part25part1_globalsl1_qp
