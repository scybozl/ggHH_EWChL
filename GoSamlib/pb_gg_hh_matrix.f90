module     pb_gg_hh_matrix
   ...
   use pb_gg_hh_model, only: Nf, NC, sqrt2, init_functions
   use pb_gg_hh_color, only: TR, CA, CF, numcs, &
     & incolors, init_color
   use pb_gg_hh_amplitudeh0, only: samplitudeh0l1 => samplitude, &
        &   finite_renormalisation0 => finite_renormalisation
   use pb_gg_hh_amplitudeh1, only: samplitudeh1l1 => samplitude, &
        &   finite_renormalisation1 => finite_renormalisation
   use pb_gg_hh_amplitudeh3, only: samplitudeh3l1 => samplitude, &
        &   finite_renormalisation3 => finite_renormalisation
   use pb_gg_hh_dipoles, only: insertion_operator, insertion_operator_qed
...
contains
   ...
   function     samplitudel0(vecs, h) result(amp)
      use pb_gg_hh_config, only: logfile
      use pb_gg_hh_kinematics, only: init_event
      implicit none
      real(ki), dimension(4, 4), intent(in) :: vecs
   ...
   pure function square_0l_0l_sc(color_vector1, color_vector2) result(amp)
      use pb_gg_hh_color, only: cmat => CC
      implicit none
   ...
   pure function square_1_2_sc(color_vector1, color_vector2) result(amp)
      use pb_gg_hh_color, only: cmat => T1T2
