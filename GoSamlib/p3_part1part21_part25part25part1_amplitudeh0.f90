...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
     ...
     & only: init_lo, rat2
      use p3_part1part21_part25part25part1_abbrevd84h0, only: init_abbrevd84 => init_abbrev
      use p3_part1part21_part25part25part1_abbrevd11h0, only: init_abbrevd11 => init_abbrev
      use p3_part1part21_part25part25part1_abbrevd86h0, only: init_abbrevd86 => init_abbrev
      use p3_part1part21_part25part25part1_abbrevd88h0, only: init_abbrevd88 => init_abbrev
      use p3_part1part21_part25part25part1_groups
      implicit none
      real(ki), intent(in) :: scale2
