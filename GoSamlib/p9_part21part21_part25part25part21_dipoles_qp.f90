module     p9_part21part21_part25part25part21_dipoles_qp
   use p9_part21part21_part25part25part21_config, only: ki => ki_qp
   use p9_part21part21_part25part25part21_color_qp, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T5, &
       & T2T5
   use p9_part21part21_part25part25part21_kinematics_qp, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p9_part21part21_part25part25part21_dipoles_qp
