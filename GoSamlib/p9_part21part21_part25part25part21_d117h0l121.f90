module     p9_part21part21_part25part25part21_d117h0l121
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/GoSam_POWHEG/p9_part21p &
   ! &art21_part25part25part21/helicity0d117h0l121.f90
...
!---#[ subroutine brack_0:
   pure subroutine brack_0(ninjaA0, brack)
      ...
      use p9_part21part21_part25part25part21_abbrevd117h0
      implicit none
      complex(ki), dimension(4), intent(in) :: ninjaA0
      complex(ki), dimension(3) :: acd117
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd117(1)=dotproduct(ninjaA0,ninjaA0)
      acd117(2)=abb117(35)
      acd117(3)=acd117(2)*acd117(1)**2
      brack(ninjaidxt0)=acd117(3)
   end subroutine brack_0
!---#] subroutine brack_0:
!---#[ subroutine numerator_tmu:
   subroutine numerator_tmu(ncut, a, coeffs) &
   & bind(c, name="p9_part21part21_part25part25part21_d117h0_ninja_tmu")
...
!---#] subroutine numerator_tmu:
end module     p9_part21part21_part25part25part21_d117h0l121
