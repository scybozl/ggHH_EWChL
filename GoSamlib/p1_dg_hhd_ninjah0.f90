...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p1_dg_hhd_model
   use p1_dg_hhd_d4h0l1, only: numerator_diagram4 => numerator_ninja
   use p1_dg_hhd_d4h0l121, only: numerator_tmu_diagram4 => numerator_tmu
   use p1_dg_hhd_d4h0l131, only: numerator_t3_diagram4 => numerator_t3
   use p1_dg_hhd_d4h0l132, only: numerator_t2_diagram4 => numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p1_dg_hhd_kinematics
   use p1_dg_hhd_model
   use p1_dg_hhd_d1h0l1, only: numerator_diagram1 => numerator_ninja
   use p1_dg_hhd_d1h0l121, only: numerator_tmu_diagram1 => numerator_tmu
   use p1_dg_hhd_d1h0l131, only: numerator_t3_diagram1 => numerator_t3
   use p1_dg_hhd_d1h0l132, only: numerator_t2_diagram1 => numerator_t2
   use p1_dg_hhd_d6h0l1, only: numerator_diagram6 => numerator_ninja
   use p1_dg_hhd_d6h0l121, only: numerator_tmu_diagram6 => numerator_tmu
   use p1_dg_hhd_d6h0l131, only: numerator_t3_diagram6 => numerator_t3
   use p1_dg_hhd_d6h0l132, only: numerator_t2_diagram6 => numerator_t2
   use p1_dg_hhd_globalsl1, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p1_dg_hhd_kinematics
   use p1_dg_hhd_model
   use p1_dg_hhd_d8h0l1, only: numerator_diagram8 => numerator_ninja
   use p1_dg_hhd_d8h0l121, only: numerator_tmu_diagram8 => numerator_tmu
   use p1_dg_hhd_d8h0l131, only: numerator_t3_diagram8 => numerator_t3
   use p1_dg_hhd_d8h0l132, only: numerator_t2_diagram8 => numerator_t2
   use p1_dg_hhd_globalsl1, only: epspow
