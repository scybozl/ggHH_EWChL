...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part25part25part1_d84h2l1, only: numerator_diagram84 => n&
   &umerator_ninja
   use p3_part1part21_part25part25part1_d84h2l121, only: numerator_tmu_diagram84 &
   &=> numerator_tmu
   use p3_part1part21_part25part25part1_d84h2l131, only: numerator_t3_diagram84 &
   &=> numerator_t3
   use p3_part1part21_part25part25part1_d84h2l132, only: numerator_t2_diagram84 &
   &=> numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   &=> numerator_t2
   use p3_part1part21_part25part25part1_d86h2l1, only: numerator_diagram86 => n&
   &umerator_ninja
   use p3_part1part21_part25part25part1_d86h2l121, only: numerator_tmu_diagram86 &
   &=> numerator_tmu
   use p3_part1part21_part25part25part1_d86h2l131, only: numerator_t3_diagram86 &
   &=> numerator_t3
   use p3_part1part21_part25part25part1_d86h2l132, only: numerator_t2_diagram86 &
   &=> numerator_t2
   use p3_part1part21_part25part25part1_globalsl1, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part25part25part1_kinematics
   use p3_part1part21_part25part25part1_model
   use p3_part1part21_part25part25part1_d88h2l1, only: numerator_diagram88 => n&
   &umerator_ninja
   use p3_part1part21_part25part25part1_d88h2l121, only: numerator_tmu_diagram88 &
   &=> numerator_tmu
   use p3_part1part21_part25part25part1_d88h2l131, only: numerator_t3_diagram88 &
   &=> numerator_t3
   use p3_part1part21_part25part25part1_d88h2l132, only: numerator_t2_diagram88 &
   &=> numerator_t2
   use p3_part1part21_part25part25part1_globalsl1, only: epspow
