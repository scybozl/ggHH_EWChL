module     p0_part21part21_part25part25_model
   ...
   real(ki) :: mdlaS =        0.079577470000000_ki
   ...
   character(len=name_length), dimension(35) :: names = (/&
      & "gauge1z  ", &
      & "gauge2z  ", &
      & "mdlaEWM1 ", &
      & "mdlaS    ", &
...
!---#] utility functions for model initialization:
end module p0_part21part21_part25part25_model
