module     p3_part1part21_part25part25part1_d7h2l121
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/GoSam_POWHEG/Virtual/p3 &
   ! &_part1part21_part25part25part1/helicity2d7h2l121.f90
...
!---#[ subroutine brack_0:
   pure subroutine brack_0(ninjaA0, brack)
      ...
      complex(ki), dimension(3) :: acd7
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd7(1)=dotproduct(ninjaA0,ninjaA0)
      acd7(2)=abb7(7)
      acd7(3)=-acd7(2)*acd7(1)**2
      brack(ninjaidxt0)=acd7(3)
   end subroutine brack_0
!---#] subroutine brack_0:
!---#[ subroutine numerator_tmu:
   subroutine numerator_tmu(ncut, a, coeffs) &
   & bind(c, name="p3_part1part21_part25part25part1_d7h2_ninja_tmu")
...
!---#] subroutine numerator_tmu:
end module     p3_part1part21_part25part25part1_d7h2l121
