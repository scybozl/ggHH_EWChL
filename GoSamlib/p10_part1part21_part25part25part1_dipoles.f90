module     p10_part1part21_part25part25part1_dipoles
   use p10_part1part21_part25part25part1_config, only: ki
   use p10_part1part21_part25part25part1_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T5, &
       & T2T5
   use p10_part1part21_part25part25part1_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p10_part1part21_part25part25part1_dipoles
