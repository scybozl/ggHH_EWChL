!
module     p10_part1part21_part25part25part1_ninjah0_qp
...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p10_part1part21_part25part25part1_d84h0l1_qp, only: numerator_diagram84 &
   &=> numerator_ninja
   use p10_part1part21_part25part25part1_d84h0l121_qp, only: numerator_tmu_diag&
   &ram84 => numerator_tmu
   use p10_part1part21_part25part25part1_d84h0l131_qp, only: numerator_t3_diagr&
   &am84 => numerator_t3
   use p10_part1part21_part25part25part1_d84h0l132_qp, only: numerator_t2_diagr&
   &am84 => numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p10_part1part21_part25part25part1_kinematics_qp
   use p10_part1part21_part25part25part1_model_qp
   use p10_part1part21_part25part25part1_d11h0l1_qp, only: numerator_diagram11 &
   &=> numerator_ninja
   use p10_part1part21_part25part25part1_d11h0l121_qp, only: numerator_tmu_diag&
   &ram11 => numerator_tmu
   use p10_part1part21_part25part25part1_d11h0l131_qp, only: numerator_t3_diagr&
   &am11 => numerator_t3
   use p10_part1part21_part25part25part1_d11h0l132_qp, only: numerator_t2_diagr&
   &am11 => numerator_t2
   use p10_part1part21_part25part25part1_d86h0l1_qp, only: numerator_diagram86 &
   &=> numerator_ninja
   use p10_part1part21_part25part25part1_d86h0l121_qp, only: numerator_tmu_diag&
   &ram86 => numerator_tmu
   use p10_part1part21_part25part25part1_d86h0l131_qp, only: numerator_t3_diagr&
   &am86 => numerator_t3
   use p10_part1part21_part25part25part1_d86h0l132_qp, only: numerator_t2_diagr&
   &am86 => numerator_t2
   use p10_part1part21_part25part25part1_globalsl1_qp, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p10_part1part21_part25part25part1_kinematics_qp
   use p10_part1part21_part25part25part1_model_qp
   use p10_part1part21_part25part25part1_d88h0l1_qp, only: numerator_diagram88 &
   &=> numerator_ninja
   use p10_part1part21_part25part25part1_d88h0l121_qp, only: numerator_tmu_diag&
   &ram88 => numerator_tmu
   use p10_part1part21_part25part25part1_d88h0l131_qp, only: numerator_t3_diagr&
   &am88 => numerator_t3
   use p10_part1part21_part25part25part1_d88h0l132_qp, only: numerator_t2_diagr&
   &am88 => numerator_t2
   use p10_part1part21_part25part25part1_globalsl1_qp, only: epspow
...
!-----#] subroutine ninja_reduce_group2:
!---#] reduce groups with ninja:
end module p10_part1part21_part25part25part1_ninjah0_qp
