module     p3_part1part21_part25part25part1_golem95h2
...
subroutine     reconstruct_group0(coeffs)
   ...
   use p3_part1part21_part25part25part1_d7h2l1, only: numerator_d7 => numerator&
   &_golem95
   use p3_part1part21_part25part25part1_d7h2l1d, only: reconstruct_d7
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p3_part1part21_part25part25part1_d1h2l1, only: numerator_d1 => numerator&
   &_golem95
   use p3_part1part21_part25part25part1_d1h2l1d, only: reconstruct_d1
   use p3_part1part21_part25part25part1_d9h2l1, only: numerator_d9 => numerator&
   &_golem95
   use p3_part1part21_part25part25part1_d9h2l1d, only: reconstruct_d9
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p3_part1part21_part25part25part1_d11h2l1, only: numerator_d11 => numerat&
   &or_golem95
   use p3_part1part21_part25part25part1_d11h2l1d, only: reconstruct_d11
   implicit none
...
!---#] subroutine reconstruct_group2:
end module p3_part1part21_part25part25part1_golem95h2
