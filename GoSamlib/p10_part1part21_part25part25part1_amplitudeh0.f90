module    p10_part1part21_part25part25part1_amplitudeh0
   ...
   use p10_part1part21_part25part25part1_ninjah0
...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      ...
      use p10_part1part21_part25part25part1_diagramsh0l0, only: amplitudel0 => amplitude
      implicit none
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p10_part1part21_part25part25part1_abbrevd84h0, only: init_abbrevd84 => init_abbrev
      use p10_part1part21_part25part25part1_abbrevd11h0, only: init_abbrevd11 => init_abbrev
      use p10_part1part21_part25part25part1_abbrevd86h0, only: init_abbrevd86 => init_abbrev
      use p10_part1part21_part25part25part1_abbrevd88h0, only: init_abbrevd88 => init_abbrev
      use p10_part1part21_part25part25part1_diagramsh0l0, only: amplitudel0 => amplitude
      use p10_part1part21_part25part25part1_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p10_part1part21_part25part25part1_ninjah0, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   use p10_part1part21_part25part25part1_config, only: &
      & logfile, debug_nlo_diagrams
   use p10_part1part21_part25part25part1_globalsl1, only: epspow
   use p10_part1part21_part25part25part1_ninjah0, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   use p10_part1part21_part25part25part1_config, only: &
      & logfile, debug_nlo_diagrams
   use p10_part1part21_part25part25part1_globalsl1, only: epspow
   use p10_part1part21_part25part25part1_ninjah0, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group2:
end module p10_part1part21_part25part25part1_amplitudeh0
