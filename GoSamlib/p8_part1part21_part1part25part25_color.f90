module     p8_part1part21_part1part25part25_color
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/p8_part1part21_part1part25part25/common/color.f90 
   ! generator: buildcolor.py
   use p8_part1part21_part1part25part25_config, only: ki
   use p8_part1part21_part1part25part25_model, only: NC, Nf
   implicit none
   private
   save
...
end module p8_part1part21_part1part25part25_color
