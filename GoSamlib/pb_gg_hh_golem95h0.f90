...
subroutine     reconstruct_group0(coeffs)
   ...
   use pb_gg_hh_d10h0l1, only: numerator_d10 => numerator_golem95
   use pb_gg_hh_d10h0l1d, only: reconstruct_d10
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use pb_gg_hh_d4h0l1, only: numerator_d4 => numerator_golem95
   use pb_gg_hh_d4h0l1d, only: reconstruct_d4
   use pb_gg_hh_d8h0l1, only: numerator_d8 => numerator_golem95
   use pb_gg_hh_d8h0l1d, only: reconstruct_d8
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use pb_gg_hh_d6h0l1, only: numerator_d6 => numerator_golem95
   use pb_gg_hh_d6h0l1d, only: reconstruct_d6
   implicit none
