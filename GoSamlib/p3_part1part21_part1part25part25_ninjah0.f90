!
module     p3_part1part21_part1part25part25_ninjah0
...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part1part25part25_d84h0l1, only: numerator_diagram84 => n&
   &umerator_ninja
   use p3_part1part21_part1part25part25_d84h0l121, only: numerator_tmu_diagram84 &
   &=> numerator_tmu
   use p3_part1part21_part1part25part25_d84h0l131, only: numerator_t3_diagram84 &
   &=> numerator_t3
   use p3_part1part21_part1part25part25_d84h0l132, only: numerator_t2_diagram84 &
   &=> numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part1part25part25_kinematics
   use p3_part1part21_part1part25part25_model
   use p3_part1part21_part1part25part25_d86h0l1, only: numerator_diagram86 => n&
   &umerator_ninja
   use p3_part1part21_part1part25part25_d86h0l121, only: numerator_tmu_diagram86 &
   &=> numerator_tmu
   use p3_part1part21_part1part25part25_d86h0l131, only: numerator_t3_diagram86 &
   &=> numerator_t3
   use p3_part1part21_part1part25part25_d86h0l132, only: numerator_t2_diagram86 &
   &=> numerator_t2
   use p3_part1part21_part1part25part25_globalsl1, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part1part25part25_kinematics
   use p3_part1part21_part1part25part25_model
   use p3_part1part21_part1part25part25_d11h0l1, only: numerator_diagram11 => n&
   &umerator_ninja
   use p3_part1part21_part1part25part25_d11h0l121, only: numerator_tmu_diagram11 &
   &=> numerator_tmu
   use p3_part1part21_part1part25part25_d11h0l131, only: numerator_t3_diagram11 &
   &=> numerator_t3
   use p3_part1part21_part1part25part25_d11h0l132, only: numerator_t2_diagram11 &
   &=> numerator_t2
   use p3_part1part21_part1part25part25_d88h0l1, only: numerator_diagram88 => n&
   &umerator_ninja
   use p3_part1part21_part1part25part25_d88h0l121, only: numerator_tmu_diagram88 &
   &=> numerator_tmu
   use p3_part1part21_part1part25part25_d88h0l131, only: numerator_t3_diagram88 &
   &=> numerator_t3
   use p3_part1part21_part1part25part25_d88h0l132, only: numerator_t2_diagram88 &
   &=> numerator_t2
   use p3_part1part21_part1part25part25_globalsl1, only: epspow
...
!-----#] subroutine ninja_reduce_group2:
!---#] reduce groups with ninja:
end module p3_part1part21_part1part25part25_ninjah0
