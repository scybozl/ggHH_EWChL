module     p1_part21part21_part21part25part25_golem95h0
...
subroutine     reconstruct_group0(coeffs)
   ...
   use p1_part21part21_part21part25part25_d206h0l1, only: numerator_d206 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d206h0l1d, only: reconstruct_d206
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p1_part21part21_part21part25part25_d38h0l1, only: numerator_d38 => numer&
   &ator_golem95
   use p1_part21part21_part21part25part25_d38h0l1d, only: reconstruct_d38
   use p1_part21part21_part21part25part25_d42h0l1, only: numerator_d42 => numer&
   &ator_golem95
   use p1_part21part21_part21part25part25_d42h0l1d, only: reconstruct_d42
   use p1_part21part21_part21part25part25_d56h0l1, only: numerator_d56 => numer&
   &ator_golem95
   use p1_part21part21_part21part25part25_d56h0l1d, only: reconstruct_d56
   use p1_part21part21_part21part25part25_d129h0l1, only: numerator_d129 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d129h0l1d, only: reconstruct_d129
   use p1_part21part21_part21part25part25_d137h0l1, only: numerator_d137 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d137h0l1d, only: reconstruct_d137
   use p1_part21part21_part21part25part25_d149h0l1, only: numerator_d149 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d149h0l1d, only: reconstruct_d149
   use p1_part21part21_part21part25part25_d196h0l1, only: numerator_d196 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d196h0l1d, only: reconstruct_d196
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p1_part21part21_part21part25part25_d133h0l1, only: numerator_d133 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d133h0l1d, only: reconstruct_d133
   use p1_part21part21_part21part25part25_d204h0l1, only: numerator_d204 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d204h0l1d, only: reconstruct_d204
   implicit none
...
subroutine     reconstruct_group3(coeffs)
   ...
   use p1_part21part21_part21part25part25_d125h0l1, only: numerator_d125 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d125h0l1d, only: reconstruct_d125
   use p1_part21part21_part21part25part25_d141h0l1, only: numerator_d141 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d141h0l1d, only: reconstruct_d141
   use p1_part21part21_part21part25part25_d200h0l1, only: numerator_d200 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d200h0l1d, only: reconstruct_d200
   implicit none
...
subroutine     reconstruct_group4(coeffs)
   ...
   use p1_part21part21_part21part25part25_d192h0l1, only: numerator_d192 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d192h0l1d, only: reconstruct_d192
   implicit none
...
subroutine     reconstruct_group5(coeffs)
   ...
   use p1_part21part21_part21part25part25_d54h0l1, only: numerator_d54 => numer&
   &ator_golem95
   use p1_part21part21_part21part25part25_d54h0l1d, only: reconstruct_d54
   use p1_part21part21_part21part25part25_d147h0l1, only: numerator_d147 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d147h0l1d, only: reconstruct_d147
   use p1_part21part21_part21part25part25_d188h0l1, only: numerator_d188 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d188h0l1d, only: reconstruct_d188
   implicit none
...
subroutine     reconstruct_group6(coeffs)
   ...
   use p1_part21part21_part21part25part25_d202h0l1, only: numerator_d202 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d202h0l1d, only: reconstruct_d202
   implicit none
...
subroutine     reconstruct_group7(coeffs)
   ...
   use p1_part21part21_part21part25part25_d121h0l1, only: numerator_d121 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d121h0l1d, only: reconstruct_d121
   use p1_part21part21_part21part25part25_d198h0l1, only: numerator_d198 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d198h0l1d, only: reconstruct_d198
   implicit none
...
subroutine     reconstruct_group8(coeffs)
   use tens_rec
   use p1_part21part21_part21part25part25_config
   use p1_part21part21_part21part25part25_groups, only: tensrec_info_group8
   use p1_part21part21_part21part25part25_d194h0l1, only: numerator_d194 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d194h0l1d, only: reconstruct_d194
   implicit none
...
subroutine     reconstruct_group9(coeffs)
   ...
   use p1_part21part21_part21part25part25_d117h0l1, only: numerator_d117 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d117h0l1d, only: reconstruct_d117
   use p1_part21part21_part21part25part25_d184h0l1, only: numerator_d184 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d184h0l1d, only: reconstruct_d184
   implicit none
...
subroutine     reconstruct_group10(coeffs)
   ...
   use p1_part21part21_part21part25part25_d109h0l1, only: numerator_d109 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d109h0l1d, only: reconstruct_d109
   use p1_part21part21_part21part25part25_d190h0l1, only: numerator_d190 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d190h0l1d, only: reconstruct_d190
   implicit none
...
subroutine     reconstruct_group11(coeffs)
   ...
   use p1_part21part21_part21part25part25_d34h0l1, only: numerator_d34 => numer&
   &ator_golem95
   use p1_part21part21_part21part25part25_d34h0l1d, only: reconstruct_d34
   use p1_part21part21_part21part25part25_d52h0l1, only: numerator_d52 => numer&
   &ator_golem95
   use p1_part21part21_part21part25part25_d52h0l1d, only: reconstruct_d52
   use p1_part21part21_part21part25part25_d113h0l1, only: numerator_d113 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d113h0l1d, only: reconstruct_d113
   use p1_part21part21_part21part25part25_d145h0l1, only: numerator_d145 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d145h0l1d, only: reconstruct_d145
   use p1_part21part21_part21part25part25_d186h0l1, only: numerator_d186 => num&
   &erator_golem95
   use p1_part21part21_part21part25part25_d186h0l1d, only: reconstruct_d186
   implicit none
...
!---#] subroutine reconstruct_group11:
end module p1_part21part21_part21part25part25_golem95h0
