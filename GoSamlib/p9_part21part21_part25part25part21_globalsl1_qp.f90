module     p9_part21part21_part25part25part21_globalsl1_qp
...
contains
   ...
   pure function ccontract_cc(color_vector1, color_vector2) result(amp)
      use p9_part21part21_part25part25part21_color_qp, only: cmat => CC
      implicit none
   ...
   !---#] function ccontract_rc:
end module p9_part21part21_part25part25part21_globalsl1_qp
