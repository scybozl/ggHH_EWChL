!
module     p2_part21part21_part25part25part21_ninjah0_qp
...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_d38h0l1_qp, only: numerator_diagram38 &
   &=> numerator_ninja
   use p2_part21part21_part25part25part21_d38h0l121_qp, only: numerator_tmu_dia&
   &gram38 => numerator_tmu
   use p2_part21part21_part25part25part21_d38h0l131_qp, only: numerator_t3_diag&
   &ram38 => numerator_t3
   use p2_part21part21_part25part25part21_d38h0l132_qp, only: numerator_t2_diag&
   &ram38 => numerator_t2
   use p2_part21part21_part25part25part21_d56h0l1_qp, only: numerator_diagram56 &
   &=> numerator_ninja
   use p2_part21part21_part25part25part21_d56h0l121_qp, only: numerator_tmu_dia&
   &gram56 => numerator_tmu
   use p2_part21part21_part25part25part21_d56h0l131_qp, only: numerator_t3_diag&
   &ram56 => numerator_t3
   use p2_part21part21_part25part25part21_d56h0l132_qp, only: numerator_t2_diag&
   &ram56 => numerator_t2
   use p2_part21part21_part25part25part21_d125h0l1_qp, only: numerator_diagram1&
   &25 => numerator_ninja
   use p2_part21part21_part25part25part21_d125h0l121_qp, only: numerator_tmu_di&
   &agram125 => numerator_tmu
   use p2_part21part21_part25part25part21_d125h0l131_qp, only: numerator_t3_dia&
   &gram125 => numerator_t3
   use p2_part21part21_part25part25part21_d125h0l132_qp, only: numerator_t2_dia&
   &gram125 => numerator_t2
   use p2_part21part21_part25part25part21_d149h0l1_qp, only: numerator_diagram1&
   &49 => numerator_ninja
   use p2_part21part21_part25part25part21_d149h0l121_qp, only: numerator_tmu_di&
   &agram149 => numerator_tmu
   use p2_part21part21_part25part25part21_d149h0l131_qp, only: numerator_t3_dia&
   &gram149 => numerator_t3
   use p2_part21part21_part25part25part21_d149h0l132_qp, only: numerator_t2_dia&
   &gram149 => numerator_t2
   use p2_part21part21_part25part25part21_d206h0l1_qp, only: numerator_diagram2&
   &06 => numerator_ninja
   use p2_part21part21_part25part25part21_d206h0l121_qp, only: numerator_tmu_di&
   &agram206 => numerator_tmu
   use p2_part21part21_part25part25part21_d206h0l131_qp, only: numerator_t3_dia&
   &gram206 => numerator_t3
   use p2_part21part21_part25part25part21_d206h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d196h0l1_qp, only: numerator_diagram1&
   &96 => numerator_ninja
   use p2_part21part21_part25part25part21_d196h0l121_qp, only: numerator_tmu_di&
   &agram196 => numerator_tmu
   use p2_part21part21_part25part25part21_d196h0l131_qp, only: numerator_t3_dia&
   &gram196 => numerator_t3
   use p2_part21part21_part25part25part21_d196h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d121h0l1_qp, only: numerator_diagram1&
   &21 => numerator_ninja
   use p2_part21part21_part25part25part21_d121h0l121_qp, only: numerator_tmu_di&
   &agram121 => numerator_tmu
   use p2_part21part21_part25part25part21_d121h0l131_qp, only: numerator_t3_dia&
   &gram121 => numerator_t3
   use p2_part21part21_part25part25part21_d121h0l132_qp, only: numerator_t2_dia&
   &gram121 => numerator_t2
   use p2_part21part21_part25part25part21_d204h0l1_qp, only: numerator_diagram2&
   &04 => numerator_ninja
   use p2_part21part21_part25part25part21_d204h0l121_qp, only: numerator_tmu_di&
   &agram204 => numerator_tmu
   use p2_part21part21_part25part25part21_d204h0l131_qp, only: numerator_t3_dia&
   &gram204 => numerator_t3
   use p2_part21part21_part25part25part21_d204h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group3(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d200h0l1_qp, only: numerator_diagram2&
   &00 => numerator_ninja
   use p2_part21part21_part25part25part21_d200h0l121_qp, only: numerator_tmu_di&
   &agram200 => numerator_tmu
   use p2_part21part21_part25part25part21_d200h0l131_qp, only: numerator_t3_dia&
   &gram200 => numerator_t3
   use p2_part21part21_part25part25part21_d200h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group4(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d192h0l1_qp, only: numerator_diagram1&
   &92 => numerator_ninja
   use p2_part21part21_part25part25part21_d192h0l121_qp, only: numerator_tmu_di&
   &agram192 => numerator_tmu
   use p2_part21part21_part25part25part21_d192h0l131_qp, only: numerator_t3_dia&
   &gram192 => numerator_t3
   use p2_part21part21_part25part25part21_d192h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group5(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d188h0l1_qp, only: numerator_diagram1&
   &88 => numerator_ninja
   use p2_part21part21_part25part25part21_d188h0l121_qp, only: numerator_tmu_di&
   &agram188 => numerator_tmu
   use p2_part21part21_part25part25part21_d188h0l131_qp, only: numerator_t3_dia&
   &gram188 => numerator_t3
   use p2_part21part21_part25part25part21_d188h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group6(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d137h0l1_qp, only: numerator_diagram1&
   &37 => numerator_ninja
   use p2_part21part21_part25part25part21_d137h0l121_qp, only: numerator_tmu_di&
   &agram137 => numerator_tmu
   use p2_part21part21_part25part25part21_d137h0l131_qp, only: numerator_t3_dia&
   &gram137 => numerator_t3
   use p2_part21part21_part25part25part21_d137h0l132_qp, only: numerator_t2_dia&
   &gram137 => numerator_t2
   use p2_part21part21_part25part25part21_d202h0l1_qp, only: numerator_diagram2&
   &02 => numerator_ninja
   use p2_part21part21_part25part25part21_d202h0l121_qp, only: numerator_tmu_di&
   &agram202 => numerator_tmu
   use p2_part21part21_part25part25part21_d202h0l131_qp, only: numerator_t3_dia&
   &gram202 => numerator_t3
   use p2_part21part21_part25part25part21_d202h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group7(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d133h0l1_qp, only: numerator_diagram1&
   &33 => numerator_ninja
   use p2_part21part21_part25part25part21_d133h0l121_qp, only: numerator_tmu_di&
   &agram133 => numerator_tmu
   use p2_part21part21_part25part25part21_d133h0l131_qp, only: numerator_t3_dia&
   &gram133 => numerator_t3
   use p2_part21part21_part25part25part21_d133h0l132_qp, only: numerator_t2_dia&
   &gram133 => numerator_t2
   use p2_part21part21_part25part25part21_d198h0l1_qp, only: numerator_diagram1&
   &98 => numerator_ninja
   use p2_part21part21_part25part25part21_d198h0l121_qp, only: numerator_tmu_di&
   &agram198 => numerator_tmu
   use p2_part21part21_part25part25part21_d198h0l131_qp, only: numerator_t3_dia&
   &gram198 => numerator_t3
   use p2_part21part21_part25part25part21_d198h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group8(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d52h0l1_qp, only: numerator_diagram52 &
   &=> numerator_ninja
   use p2_part21part21_part25part25part21_d52h0l121_qp, only: numerator_tmu_dia&
   &gram52 => numerator_tmu
   use p2_part21part21_part25part25part21_d52h0l131_qp, only: numerator_t3_diag&
   &ram52 => numerator_t3
   use p2_part21part21_part25part25part21_d52h0l132_qp, only: numerator_t2_diag&
   &ram52 => numerator_t2
   use p2_part21part21_part25part25part21_d129h0l1_qp, only: numerator_diagram1&
   &29 => numerator_ninja
   use p2_part21part21_part25part25part21_d129h0l121_qp, only: numerator_tmu_di&
   &agram129 => numerator_tmu
   use p2_part21part21_part25part25part21_d129h0l131_qp, only: numerator_t3_dia&
   &gram129 => numerator_t3
   use p2_part21part21_part25part25part21_d129h0l132_qp, only: numerator_t2_dia&
   &gram129 => numerator_t2
   use p2_part21part21_part25part25part21_d145h0l1_qp, only: numerator_diagram1&
   &45 => numerator_ninja
   use p2_part21part21_part25part25part21_d145h0l121_qp, only: numerator_tmu_di&
   &agram145 => numerator_tmu
   use p2_part21part21_part25part25part21_d145h0l131_qp, only: numerator_t3_dia&
   &gram145 => numerator_t3
   use p2_part21part21_part25part25part21_d145h0l132_qp, only: numerator_t2_dia&
   &gram145 => numerator_t2
   use p2_part21part21_part25part25part21_d194h0l1_qp, only: numerator_diagram1&
   &94 => numerator_ninja
   use p2_part21part21_part25part25part21_d194h0l121_qp, only: numerator_tmu_di&
   &agram194 => numerator_tmu
   use p2_part21part21_part25part25part21_d194h0l131_qp, only: numerator_t3_dia&
   &gram194 => numerator_t3
   use p2_part21part21_part25part25part21_d194h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group9(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d117h0l1_qp, only: numerator_diagram1&
   &17 => numerator_ninja
   use p2_part21part21_part25part25part21_d117h0l121_qp, only: numerator_tmu_di&
   &agram117 => numerator_tmu
   use p2_part21part21_part25part25part21_d117h0l131_qp, only: numerator_t3_dia&
   &gram117 => numerator_t3
   use p2_part21part21_part25part25part21_d117h0l132_qp, only: numerator_t2_dia&
   &gram117 => numerator_t2
   use p2_part21part21_part25part25part21_d184h0l1_qp, only: numerator_diagram1&
   &84 => numerator_ninja
   use p2_part21part21_part25part25part21_d184h0l121_qp, only: numerator_tmu_di&
   &agram184 => numerator_tmu
   use p2_part21part21_part25part25part21_d184h0l131_qp, only: numerator_t3_dia&
   &gram184 => numerator_t3
   use p2_part21part21_part25part25part21_d184h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group10(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d34h0l1_qp, only: numerator_diagram34 &
   &=> numerator_ninja
   use p2_part21part21_part25part25part21_d34h0l121_qp, only: numerator_tmu_dia&
   &gram34 => numerator_tmu
   use p2_part21part21_part25part25part21_d34h0l131_qp, only: numerator_t3_diag&
   &ram34 => numerator_t3
   use p2_part21part21_part25part25part21_d34h0l132_qp, only: numerator_t2_diag&
   &ram34 => numerator_t2
   use p2_part21part21_part25part25part21_d42h0l1_qp, only: numerator_diagram42 &
   &=> numerator_ninja
   use p2_part21part21_part25part25part21_d42h0l121_qp, only: numerator_tmu_dia&
   &gram42 => numerator_tmu
   use p2_part21part21_part25part25part21_d42h0l131_qp, only: numerator_t3_diag&
   &ram42 => numerator_t3
   use p2_part21part21_part25part25part21_d42h0l132_qp, only: numerator_t2_diag&
   &ram42 => numerator_t2
   use p2_part21part21_part25part25part21_d54h0l1_qp, only: numerator_diagram54 &
   &=> numerator_ninja
   use p2_part21part21_part25part25part21_d54h0l121_qp, only: numerator_tmu_dia&
   &gram54 => numerator_tmu
   use p2_part21part21_part25part25part21_d54h0l131_qp, only: numerator_t3_diag&
   &ram54 => numerator_t3
   use p2_part21part21_part25part25part21_d54h0l132_qp, only: numerator_t2_diag&
   &ram54 => numerator_t2
   use p2_part21part21_part25part25part21_d109h0l1_qp, only: numerator_diagram1&
   &09 => numerator_ninja
   use p2_part21part21_part25part25part21_d109h0l121_qp, only: numerator_tmu_di&
   &agram109 => numerator_tmu
   use p2_part21part21_part25part25part21_d109h0l131_qp, only: numerator_t3_dia&
   &gram109 => numerator_t3
   use p2_part21part21_part25part25part21_d109h0l132_qp, only: numerator_t2_dia&
   &gram109 => numerator_t2
   use p2_part21part21_part25part25part21_d141h0l1_qp, only: numerator_diagram1&
   &41 => numerator_ninja
   use p2_part21part21_part25part25part21_d141h0l121_qp, only: numerator_tmu_di&
   &agram141 => numerator_tmu
   use p2_part21part21_part25part25part21_d141h0l131_qp, only: numerator_t3_dia&
   &gram141 => numerator_t3
   use p2_part21part21_part25part25part21_d141h0l132_qp, only: numerator_t2_dia&
   &gram141 => numerator_t2
   use p2_part21part21_part25part25part21_d147h0l1_qp, only: numerator_diagram1&
   &47 => numerator_ninja
   use p2_part21part21_part25part25part21_d147h0l121_qp, only: numerator_tmu_di&
   &agram147 => numerator_tmu
   use p2_part21part21_part25part25part21_d147h0l131_qp, only: numerator_t3_dia&
   &gram147 => numerator_t3
   use p2_part21part21_part25part25part21_d147h0l132_qp, only: numerator_t2_dia&
   &gram147 => numerator_t2
   use p2_part21part21_part25part25part21_d190h0l1_qp, only: numerator_diagram1&
   &90 => numerator_ninja
   use p2_part21part21_part25part25part21_d190h0l121_qp, only: numerator_tmu_di&
   &agram190 => numerator_tmu
   use p2_part21part21_part25part25part21_d190h0l131_qp, only: numerator_t3_dia&
   &gram190 => numerator_t3
   use p2_part21part21_part25part25part21_d190h0l132_qp, only: numerator_t2_dia&
...
subroutine     ninja_reduce_group11(scale2,tot,totr,ok)
   ...
   use p2_part21part21_part25part25part21_kinematics_qp
   use p2_part21part21_part25part25part21_model_qp
   use p2_part21part21_part25part25part21_d113h0l1_qp, only: numerator_diagram1&
   &13 => numerator_ninja
   use p2_part21part21_part25part25part21_d113h0l121_qp, only: numerator_tmu_di&
   &agram113 => numerator_tmu
   use p2_part21part21_part25part25part21_d113h0l131_qp, only: numerator_t3_dia&
   &gram113 => numerator_t3
   use p2_part21part21_part25part25part21_d113h0l132_qp, only: numerator_t2_dia&
   &gram113 => numerator_t2
   use p2_part21part21_part25part25part21_d186h0l1_qp, only: numerator_diagram1&
   &86 => numerator_ninja
   use p2_part21part21_part25part25part21_d186h0l121_qp, only: numerator_tmu_di&
   &agram186 => numerator_tmu
   use p2_part21part21_part25part25part21_d186h0l131_qp, only: numerator_t3_dia&
   &gram186 => numerator_t3
   use p2_part21part21_part25part25part21_d186h0l132_qp, only: numerator_t2_dia&
...
!-----#] subroutine ninja_reduce_group11:
!---#] reduce groups with ninja:
end module p2_part21part21_part25part25part21_ninjah0_qp
