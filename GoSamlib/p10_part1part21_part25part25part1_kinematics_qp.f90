module     p10_part1part21_part25part25part1_kinematics_qp
   use p10_part1part21_part25part25part1_config, only: ki => ki_qp
   use p10_part1part21_part25part25part1_model_qp
   use p10_part1part21_part25part25part1_scalar_cache
   implicit none
   save
...
!---#[ subroutine init_event:
   subroutine     init_event(vecs, hel2)
      use p10_part1part21_part25part25part1_config, only: debug_numpolvec, logfile
      use p10_part1part21_part25part25part1_model_qp
      implicit none
...
!---#] functions dotproduct_XX:
   ...
   !---#] function epsom :
end module p10_part1part21_part25part25part1_kinematics_qp
