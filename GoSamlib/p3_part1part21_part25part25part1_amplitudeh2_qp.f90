module    p3_part1part21_part25part25part1_amplitudeh2_qp
   ...
   use p3_part1part21_part25part25part1_ninjah2_qp
...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
     ...
     & only: init_lo, rat2
      use p3_part1part21_part25part25part1_abbrevd84h2_qp, only: init_abbrevd84 => init_abbrev
      use p3_part1part21_part25part25part1_abbrevd11h2_qp, only: init_abbrevd11 => init_abbrev
      use p3_part1part21_part25part25part1_abbrevd86h2_qp, only: init_abbrevd86 => init_abbrev
      use p3_part1part21_part25part25part1_abbrevd88h2_qp, only: init_abbrevd88 => init_abbrev
      use p3_part1part21_part25part25part1_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p3_part1part21_part25part25part1_ninjah2_qp, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   use p3_part1part21_part25part25part1_config, only: &
      & logfile, debug_nlo_diagrams
   use p3_part1part21_part25part25part1_globalsl1_qp, only: epspow
   use p3_part1part21_part25part25part1_ninjah2_qp, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   use p3_part1part21_part25part25part1_config, only: &
      & logfile, debug_nlo_diagrams
   use p3_part1part21_part25part25part1_globalsl1_qp, only: epspow
   use p3_part1part21_part25part25part1_ninjah2_qp, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group2:
end module p3_part1part21_part25part25part1_amplitudeh2_qp
