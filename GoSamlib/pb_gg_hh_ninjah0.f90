...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use pb_gg_hh_model
   use pb_gg_hh_d10h0l1, only: numerator_diagram10 => numerator_ninja
   use pb_gg_hh_d10h0l121, only: numerator_tmu_diagram10 => numerator_tmu
   use pb_gg_hh_d10h0l131, only: numerator_t3_diagram10 => numerator_t3
   use pb_gg_hh_d10h0l132, only: numerator_t2_diagram10 => numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use pb_gg_hh_kinematics
   use pb_gg_hh_model
   use pb_gg_hh_d4h0l1, only: numerator_diagram4 => numerator_ninja
   use pb_gg_hh_d4h0l121, only: numerator_tmu_diagram4 => numerator_tmu
   use pb_gg_hh_d4h0l131, only: numerator_t3_diagram4 => numerator_t3
   use pb_gg_hh_d4h0l132, only: numerator_t2_diagram4 => numerator_t2
   use pb_gg_hh_d8h0l1, only: numerator_diagram8 => numerator_ninja
   use pb_gg_hh_d8h0l121, only: numerator_tmu_diagram8 => numerator_tmu
   use pb_gg_hh_d8h0l131, only: numerator_t3_diagram8 => numerator_t3
   use pb_gg_hh_d8h0l132, only: numerator_t2_diagram8 => numerator_t2
   use pb_gg_hh_globalsl1, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use pb_gg_hh_kinematics
   use pb_gg_hh_model
   use pb_gg_hh_d6h0l1, only: numerator_diagram6 => numerator_ninja
   use pb_gg_hh_d6h0l121, only: numerator_tmu_diagram6 => numerator_tmu
   use pb_gg_hh_d6h0l131, only: numerator_t3_diagram6 => numerator_t3
   use pb_gg_hh_d6h0l132, only: numerator_t2_diagram6 => numerator_t2
   use pb_gg_hh_globalsl1, only: epspow
