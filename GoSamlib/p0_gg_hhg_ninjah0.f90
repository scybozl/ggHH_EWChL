...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_model
   use p0_gg_hhg_d65h0l1, only: numerator_diagram65 => numerator_ninja
   use p0_gg_hhg_d65h0l121, only: numerator_tmu_diagram65 => numerator_tmu
   use p0_gg_hhg_d65h0l131, only: numerator_t3_diagram65 => numerator_t3
   use p0_gg_hhg_d65h0l132, only: numerator_t2_diagram65 => numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d25h0l1, only: numerator_diagram25 => numerator_ninja
   use p0_gg_hhg_d25h0l121, only: numerator_tmu_diagram25 => numerator_tmu
   use p0_gg_hhg_d25h0l131, only: numerator_t3_diagram25 => numerator_t3
   use p0_gg_hhg_d25h0l132, only: numerator_t2_diagram25 => numerator_t2
   use p0_gg_hhg_d55h0l1, only: numerator_diagram55 => numerator_ninja
   use p0_gg_hhg_d55h0l121, only: numerator_tmu_diagram55 => numerator_tmu
   use p0_gg_hhg_d55h0l131, only: numerator_t3_diagram55 => numerator_t3
   use p0_gg_hhg_d55h0l132, only: numerator_t2_diagram55 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d63h0l1, only: numerator_diagram63 => numerator_ninja
   use p0_gg_hhg_d63h0l121, only: numerator_tmu_diagram63 => numerator_tmu
   use p0_gg_hhg_d63h0l131, only: numerator_t3_diagram63 => numerator_t3
   use p0_gg_hhg_d63h0l132, only: numerator_t2_diagram63 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group3(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d19h0l1, only: numerator_diagram19 => numerator_ninja
   use p0_gg_hhg_d19h0l121, only: numerator_tmu_diagram19 => numerator_tmu
   use p0_gg_hhg_d19h0l131, only: numerator_t3_diagram19 => numerator_t3
   use p0_gg_hhg_d19h0l132, only: numerator_t2_diagram19 => numerator_t2
   use p0_gg_hhg_d59h0l1, only: numerator_diagram59 => numerator_ninja
   use p0_gg_hhg_d59h0l121, only: numerator_tmu_diagram59 => numerator_tmu
   use p0_gg_hhg_d59h0l131, only: numerator_t3_diagram59 => numerator_t3
   use p0_gg_hhg_d59h0l132, only: numerator_t2_diagram59 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group4(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d4h0l1, only: numerator_diagram4 => numerator_ninja
   use p0_gg_hhg_d4h0l121, only: numerator_tmu_diagram4 => numerator_tmu
   use p0_gg_hhg_d4h0l131, only: numerator_t3_diagram4 => numerator_t3
   use p0_gg_hhg_d4h0l132, only: numerator_t2_diagram4 => numerator_t2
   use p0_gg_hhg_d6h0l1, only: numerator_diagram6 => numerator_ninja
   use p0_gg_hhg_d6h0l121, only: numerator_tmu_diagram6 => numerator_tmu
   use p0_gg_hhg_d6h0l131, only: numerator_t3_diagram6 => numerator_t3
   use p0_gg_hhg_d6h0l132, only: numerator_t2_diagram6 => numerator_t2
   use p0_gg_hhg_d15h0l1, only: numerator_diagram15 => numerator_ninja
   use p0_gg_hhg_d15h0l121, only: numerator_tmu_diagram15 => numerator_tmu
   use p0_gg_hhg_d15h0l131, only: numerator_t3_diagram15 => numerator_t3
   use p0_gg_hhg_d15h0l132, only: numerator_t2_diagram15 => numerator_t2
   use p0_gg_hhg_d21h0l1, only: numerator_diagram21 => numerator_ninja
   use p0_gg_hhg_d21h0l121, only: numerator_tmu_diagram21 => numerator_tmu
   use p0_gg_hhg_d21h0l131, only: numerator_t3_diagram21 => numerator_t3
   use p0_gg_hhg_d21h0l132, only: numerator_t2_diagram21 => numerator_t2
   use p0_gg_hhg_d31h0l1, only: numerator_diagram31 => numerator_ninja
   use p0_gg_hhg_d31h0l121, only: numerator_tmu_diagram31 => numerator_tmu
   use p0_gg_hhg_d31h0l131, only: numerator_t3_diagram31 => numerator_t3
   use p0_gg_hhg_d31h0l132, only: numerator_t2_diagram31 => numerator_t2
   use p0_gg_hhg_d51h0l1, only: numerator_diagram51 => numerator_ninja
   use p0_gg_hhg_d51h0l121, only: numerator_tmu_diagram51 => numerator_tmu
   use p0_gg_hhg_d51h0l131, only: numerator_t3_diagram51 => numerator_t3
   use p0_gg_hhg_d51h0l132, only: numerator_t2_diagram51 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group5(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d17h0l1, only: numerator_diagram17 => numerator_ninja
   use p0_gg_hhg_d17h0l121, only: numerator_tmu_diagram17 => numerator_tmu
   use p0_gg_hhg_d17h0l131, only: numerator_t3_diagram17 => numerator_t3
   use p0_gg_hhg_d17h0l132, only: numerator_t2_diagram17 => numerator_t2
   use p0_gg_hhg_d47h0l1, only: numerator_diagram47 => numerator_ninja
   use p0_gg_hhg_d47h0l121, only: numerator_tmu_diagram47 => numerator_tmu
   use p0_gg_hhg_d47h0l131, only: numerator_t3_diagram47 => numerator_t3
   use p0_gg_hhg_d47h0l132, only: numerator_t2_diagram47 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group6(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d8h0l1, only: numerator_diagram8 => numerator_ninja
   use p0_gg_hhg_d8h0l121, only: numerator_tmu_diagram8 => numerator_tmu
   use p0_gg_hhg_d8h0l131, only: numerator_t3_diagram8 => numerator_t3
   use p0_gg_hhg_d8h0l132, only: numerator_t2_diagram8 => numerator_t2
   use p0_gg_hhg_d23h0l1, only: numerator_diagram23 => numerator_ninja
   use p0_gg_hhg_d23h0l121, only: numerator_tmu_diagram23 => numerator_tmu
   use p0_gg_hhg_d23h0l131, only: numerator_t3_diagram23 => numerator_t3
   use p0_gg_hhg_d23h0l132, only: numerator_t2_diagram23 => numerator_t2
   use p0_gg_hhg_d27h0l1, only: numerator_diagram27 => numerator_ninja
   use p0_gg_hhg_d27h0l121, only: numerator_tmu_diagram27 => numerator_tmu
   use p0_gg_hhg_d27h0l131, only: numerator_t3_diagram27 => numerator_t3
   use p0_gg_hhg_d27h0l132, only: numerator_t2_diagram27 => numerator_t2
   use p0_gg_hhg_d35h0l1, only: numerator_diagram35 => numerator_ninja
   use p0_gg_hhg_d35h0l121, only: numerator_tmu_diagram35 => numerator_tmu
   use p0_gg_hhg_d35h0l131, only: numerator_t3_diagram35 => numerator_t3
   use p0_gg_hhg_d35h0l132, only: numerator_t2_diagram35 => numerator_t2
   use p0_gg_hhg_d61h0l1, only: numerator_diagram61 => numerator_ninja
   use p0_gg_hhg_d61h0l121, only: numerator_tmu_diagram61 => numerator_tmu
   use p0_gg_hhg_d61h0l131, only: numerator_t3_diagram61 => numerator_t3
   use p0_gg_hhg_d61h0l132, only: numerator_t2_diagram61 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group7(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d57h0l1, only: numerator_diagram57 => numerator_ninja
   use p0_gg_hhg_d57h0l121, only: numerator_tmu_diagram57 => numerator_tmu
   use p0_gg_hhg_d57h0l131, only: numerator_t3_diagram57 => numerator_t3
   use p0_gg_hhg_d57h0l132, only: numerator_t2_diagram57 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group8(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d53h0l1, only: numerator_diagram53 => numerator_ninja
   use p0_gg_hhg_d53h0l121, only: numerator_tmu_diagram53 => numerator_tmu
   use p0_gg_hhg_d53h0l131, only: numerator_t3_diagram53 => numerator_t3
   use p0_gg_hhg_d53h0l132, only: numerator_t2_diagram53 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group9(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d43h0l1, only: numerator_diagram43 => numerator_ninja
   use p0_gg_hhg_d43h0l121, only: numerator_tmu_diagram43 => numerator_tmu
   use p0_gg_hhg_d43h0l131, only: numerator_t3_diagram43 => numerator_t3
   use p0_gg_hhg_d43h0l132, only: numerator_t2_diagram43 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group10(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d13h0l1, only: numerator_diagram13 => numerator_ninja
   use p0_gg_hhg_d13h0l121, only: numerator_tmu_diagram13 => numerator_tmu
   use p0_gg_hhg_d13h0l131, only: numerator_t3_diagram13 => numerator_t3
   use p0_gg_hhg_d13h0l132, only: numerator_t2_diagram13 => numerator_t2
   use p0_gg_hhg_d29h0l1, only: numerator_diagram29 => numerator_ninja
   use p0_gg_hhg_d29h0l121, only: numerator_tmu_diagram29 => numerator_tmu
   use p0_gg_hhg_d29h0l131, only: numerator_t3_diagram29 => numerator_t3
   use p0_gg_hhg_d29h0l132, only: numerator_t2_diagram29 => numerator_t2
   use p0_gg_hhg_d33h0l1, only: numerator_diagram33 => numerator_ninja
   use p0_gg_hhg_d33h0l121, only: numerator_tmu_diagram33 => numerator_tmu
   use p0_gg_hhg_d33h0l131, only: numerator_t3_diagram33 => numerator_t3
   use p0_gg_hhg_d33h0l132, only: numerator_t2_diagram33 => numerator_t2
   use p0_gg_hhg_d49h0l1, only: numerator_diagram49 => numerator_ninja
   use p0_gg_hhg_d49h0l121, only: numerator_tmu_diagram49 => numerator_tmu
   use p0_gg_hhg_d49h0l131, only: numerator_t3_diagram49 => numerator_t3
   use p0_gg_hhg_d49h0l132, only: numerator_t2_diagram49 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
...
subroutine     ninja_reduce_group11(scale2,tot,totr,ok)
   ...
   use p0_gg_hhg_kinematics
   use p0_gg_hhg_model
   use p0_gg_hhg_d45h0l1, only: numerator_diagram45 => numerator_ninja
   use p0_gg_hhg_d45h0l121, only: numerator_tmu_diagram45 => numerator_tmu
   use p0_gg_hhg_d45h0l131, only: numerator_t3_diagram45 => numerator_t3
   use p0_gg_hhg_d45h0l132, only: numerator_t2_diagram45 => numerator_t2
   use p0_gg_hhg_globalsl1, only: epspow
