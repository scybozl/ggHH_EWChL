...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
     ...
     & only: init_lo, rat2
      use pb_gg_hh_abbrevd10h0, only: init_abbrevd10 => init_abbrev
      use pb_gg_hh_abbrevd4h0, only: init_abbrevd4 => init_abbrev
      use pb_gg_hh_abbrevd8h0, only: init_abbrevd8 => init_abbrev
      use pb_gg_hh_abbrevd6h0, only: init_abbrevd6 => init_abbrev
      use pb_gg_hh_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use pb_gg_hh_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use pb_gg_hh_groups, only: contract_golem95
   use pb_gg_hh_ninjah0, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use pb_gg_hh_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use pb_gg_hh_groups, only: contract_golem95
   use pb_gg_hh_ninjah0, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use pb_gg_hh_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use pb_gg_hh_groups, only: contract_golem95
   use pb_gg_hh_ninjah0, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group2:
end module pb_gg_hh_amplitudeh0
