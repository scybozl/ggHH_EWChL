!
module     p10_part1part21_part25part25part1_ninjah0
...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p10_part1part21_part25part25part1_d84h0l1, only: numerator_diagram84 => &
   &numerator_ninja
   use p10_part1part21_part25part25part1_d84h0l121, only: numerator_tmu_diagram8&
   &4 => numerator_tmu
   use p10_part1part21_part25part25part1_d84h0l131, only: numerator_t3_diagram84 &
   &=> numerator_t3
   use p10_part1part21_part25part25part1_d84h0l132, only: numerator_t2_diagram84 &
   &=> numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p10_part1part21_part25part25part1_kinematics
   use p10_part1part21_part25part25part1_model
   use p10_part1part21_part25part25part1_d11h0l1, only: numerator_diagram11 => &
   &numerator_ninja
   use p10_part1part21_part25part25part1_d11h0l121, only: numerator_tmu_diagram1&
   &1 => numerator_tmu
   use p10_part1part21_part25part25part1_d11h0l131, only: numerator_t3_diagram11 &
   &=> numerator_t3
   use p10_part1part21_part25part25part1_d11h0l132, only: numerator_t2_diagram11 &
   &=> numerator_t2
   use p10_part1part21_part25part25part1_d86h0l1, only: numerator_diagram86 => &
   &numerator_ninja
   use p10_part1part21_part25part25part1_d86h0l121, only: numerator_tmu_diagram8&
   &6 => numerator_tmu
   use p10_part1part21_part25part25part1_d86h0l131, only: numerator_t3_diagram86 &
   &=> numerator_t3
   use p10_part1part21_part25part25part1_d86h0l132, only: numerator_t2_diagram86 &
   &=> numerator_t2
   use p10_part1part21_part25part25part1_globalsl1, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p10_part1part21_part25part25part1_kinematics
   use p10_part1part21_part25part25part1_model
   use p10_part1part21_part25part25part1_d88h0l1, only: numerator_diagram88 => &
   &numerator_ninja
   use p10_part1part21_part25part25part1_d88h0l121, only: numerator_tmu_diagram8&
   &8 => numerator_tmu
   use p10_part1part21_part25part25part1_d88h0l131, only: numerator_t3_diagram88 &
   &=> numerator_t3
   use p10_part1part21_part25part25part1_d88h0l132, only: numerator_t2_diagram88 &
   &=> numerator_t2
   use p10_part1part21_part25part25part1_globalsl1, only: epspow
...
!-----#] subroutine ninja_reduce_group2:
!---#] reduce groups with ninja:
end module p10_part1part21_part25part25part1_ninjah0
