module     p0_part21part21_part25part25_kinematics
   use p0_part21part21_part25part25_config, only: ki
   use p0_part21part21_part25part25_model
   use p0_part21part21_part25part25_scalar_cache
   implicit none
   save
   ...
   integer, parameter, public :: lo_qcd_couplings = 4
...
!---#[ subroutine init_event:
   subroutine     init_event(vecs, hel1, hel2)
      use p0_part21part21_part25part25_config, only: debug_numpolvec, logfile
      use p0_part21part21_part25part25_model
      implicit none
...
!---#] functions dotproduct_XX:
   ...
   !---#] function epsom :
end module p0_part21part21_part25part25_kinematics
