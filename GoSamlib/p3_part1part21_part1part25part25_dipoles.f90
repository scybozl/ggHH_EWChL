module     p3_part1part21_part1part25part25_dipoles
   use p3_part1part21_part1part25part25_config, only: ki
   use p3_part1part21_part1part25part25_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2, &
       & T1T3, &
       & T2T3
   use p3_part1part21_part1part25part25_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p3_part1part21_part1part25part25_dipoles
