module     p10_part1part21_part25part25part1_diagramsh0l0_qp
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/p10_part1part21_part25p &
   ! &art25part1/helicity0diagramsl0_qp.f90
...
!---#[ function amplitude:
   function amplitude()
      ...
      use p10_part1part21_part25part25part1_config, only: debug_lo_diagrams, &
        & use_sorted_sum
      use p10_part1part21_part25part25part1_accu_qp, only: sorted_sum
      use p10_part1part21_part25part25part1_util_qp, only: inspect_lo_diagram
      implicit none
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(4)=mdlGC31*i_
      abb(3)=abb(3)-abb(4)
      abb(4)=-spbk2k1*abb(3)*spbk5e2*spak2k5
      abb(3)=abb(3)*spbe2k1
      abb(5)=-es34*abb(3)
      abb(4)=abb(5)+abb(4)
      abb(4)=abb(1)*abb(4)
      abb(3)=abb(3)+abb(4)
      abb(3)=1.0_ki/2.0_ki*mdlGC7*spae2k5*abb(3)
      amplitude=c1*abb(3)
...
!---#] function amplitude:
end module p10_part1part21_part25part25part1_diagramsh0l0_qp
