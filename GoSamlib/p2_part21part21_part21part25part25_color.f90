module     p2_part21part21_part21part25part25_color
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/p2_part21part21_part21part25part25/common/color.f90 
   ! generator: buildcolor.py
   use p2_part21part21_part21part25part25_config, only: ki
   use p2_part21part21_part21part25part25_model, only: NC, Nf
   implicit none
   private
   save
...
end module p2_part21part21_part21part25part25_color
