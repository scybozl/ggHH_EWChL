module p5_partm1part21_part25part25partm1_matrix
...
contains
   ...
   pure function prefactor()
      ...
      use p3_part1part21_part25part25part1_model, only: NC
      use p3_part1part21_part25part25part1_kinematics, only: &
      & in_helicities, symmetry_factor
      use p3_part1part21_part25part25part1_color, only: incolors
      implicit none
   ...
   subroutine     initgolem(is_first)
      use p3_part1part21_part25part25part1_matrix, only: orig_initgolem => initgolem
      implicit none
   ...
   subroutine     exitgolem(is_last)
      use p3_part1part21_part25part25part1_matrix, only: orig_exitgolem => exitgolem
      implicit none
   ...
   subroutine     samplitude(vecs, scale2, amp, prec, ichecked, ok, h)
      use p3_part1part21_part25part25part1_matrix, only: orig_sub => samplitude
      implicit none
      ...
      if (present(ok)) then
         if (present(h)) then
            call orig_sub(new_vecs, scale2, amp, prec, ichecked, ok, h)
         else
            call orig_sub(new_vecs, scale2, amp, prec, ichecked, ok)
         end if
      else
         call orig_sub(new_vecs, scale2, amp, prec, ichecked, ok)
      end if
   ...
   function     samplitudel0(vecs, h) result(amp)
      use p3_part1part21_part25part25part1_matrix, only: orig_func => samplitudel0
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
   ...
   function     samplitudel1(vecs,scale2,ok,rat2,h) result(amp)
      use p3_part1part21_part25part25part1_matrix, only: orig_func => samplitudel1
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
   ...
   subroutine     ir_subtraction(vecs,scale2,amp)
      use p3_part1part21_part25part25part1_matrix, &
   ...
   subroutine OLP_color_correlated(vecs,ampcc)
      use p3_part1part21_part25part25part1_matrix, only: orig_func => OLP_color_correlated
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
   ...
   subroutine OLP_spin_correlated_lo2(vecs, ampsc)
      use p3_part1part21_part25part25part1_matrix, only: orig_func => OLP_spin_correlated_lo2
      implicit none
      real(ki), dimension(5, 4), intent(in) :: vecs
...
end module p5_partm1part21_part25part25partm1_matrix
