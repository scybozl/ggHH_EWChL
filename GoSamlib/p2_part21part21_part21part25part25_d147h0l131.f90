module     p2_part21part21_part21part25part25_d147h0l131
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/p2_part21part21_part21p &
   ! &art25part25/helicity0d147h0l131.f90
...
!---#[ subroutine brack_31:
   pure subroutine brack_31(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      use p2_part21part21_part21part25part25_abbrevd147h0
      implicit none
      ...
      acd147(2)=dotproduct(ninjaE3,spvae3e1)
      acd147(3)=dotproduct(ninjaE3,spvae2e3)
      acd147(4)=abb147(7)
      acd147(5)=dotproduct(ninjaE3,spvae2e1)
      acd147(6)=dotproduct(ninjaE3,spvae1e3)
      acd147(7)=dotproduct(ninjaE3,spvae3e2)
...
!---#[ subroutine brack_32:
   pure subroutine brack_32(ninjaA, ninjaE3, ninjaE4, ninjaP, brack)
      ...
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd147(1)=dotproduct(ninjaE3,spvae1e2)
      acd147(2)=dotproduct(ninjaE3,spvae2e3)
      acd147(3)=dotproduct(ninjaE4,spvae3e1)
      acd147(4)=abb147(7)
      acd147(5)=dotproduct(ninjaE3,spvae3e1)
      acd147(6)=dotproduct(ninjaE4,spvae2e3)
      acd147(7)=abb147(32)
      acd147(8)=dotproduct(ninjaE4,spvae1e2)
      acd147(9)=abb147(28)
      acd147(10)=dotproduct(ninjaE3,spvae3e2)
      acd147(11)=dotproduct(ninjaE3,spvae2e1)
      acd147(12)=dotproduct(ninjaE4,spvae1e3)
      acd147(13)=dotproduct(ninjaE3,spvae1e3)
      acd147(14)=dotproduct(ninjaE4,spvae2e1)
      acd147(15)=abb147(25)
      acd147(16)=dotproduct(ninjaE4,spvae3e2)
      acd147(17)=abb147(29)
      acd147(18)=dotproduct(ninjaA,ninjaE3)
      acd147(19)=dotproduct(ninjaA,spvae1e2)
      acd147(20)=dotproduct(ninjaA,spvae2e3)
      acd147(21)=dotproduct(ninjaA,spvae3e2)
      acd147(22)=dotproduct(ninjaA,spvae2e1)
      acd147(23)=dotproduct(ninjaA,spvae3e1)
      acd147(24)=dotproduct(ninjaA,spvae1e3)
      acd147(25)=abb147(3)
      acd147(26)=dotproduct(ninjaE3,spvak1e3)
      acd147(27)=abb147(16)
      acd147(28)=abb147(21)
      acd147(29)=dotproduct(ninjaE3,spvak3e1)
      acd147(30)=abb147(23)
      acd147(31)=dotproduct(ninjaE3,spvak2e1)
      acd147(32)=abb147(36)
      acd147(33)=dotproduct(ninjaE3,spvae3k1)
      acd147(34)=abb147(8)
      acd147(35)=dotproduct(ninjaE3,spvae1k3)
      acd147(36)=abb147(14)
      ...
      acd147(48)=abb147(20)
      acd147(49)=dotproduct(ninjaA,spvak1e3)
      acd147(50)=dotproduct(ninjaA,spvae3k1)
      acd147(51)=dotproduct(ninjaA,spvae1k3)
      acd147(52)=dotproduct(ninjaA,spvak3e1)
...
!---#[ subroutine numerator_t3:
   ...
   & bind(c, name="p2_part21part21_part21part25part25_d147h0_ninja_t3")
...
!---#] subroutine numerator_t3:
end module     p2_part21part21_part21part25part25_d147h0l131
