module     p0_part21part21_part25part25_golem95h0
...
subroutine     reconstruct_group0(coeffs)
   ...
   use p0_part21part21_part25part25_d13h0l1, only: numerator_d13 => numerator_g&
   &olem95
   use p0_part21part21_part25part25_d13h0l1d, only: reconstruct_d13
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p0_part21part21_part25part25_d2h0l1, only: numerator_d2 => numerator_gol&
   &em95
   use p0_part21part21_part25part25_d2h0l1d, only: reconstruct_d2
   use p0_part21part21_part25part25_d7h0l1, only: numerator_d7 => numerator_gol&
   &em95
   use p0_part21part21_part25part25_d7h0l1d, only: reconstruct_d7
   use p0_part21part21_part25part25_d11h0l1, only: numerator_d11 => numerator_g&
   &olem95
   use p0_part21part21_part25part25_d11h0l1d, only: reconstruct_d11
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   use tens_rec
   use p0_part21part21_part25part25_config
   use p0_part21part21_part25part25_groups, only: tensrec_info_group2
   use p0_part21part21_part25part25_d9h0l1, only: numerator_d9 => numerator_gol&
   &em95
   use p0_part21part21_part25part25_d9h0l1d, only: reconstruct_d9
   implicit none
...
!---#] subroutine reconstruct_group2:
end module p0_part21part21_part25part25_golem95h0
