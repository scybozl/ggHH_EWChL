module     p2_part21part21_part25part25part21_d121h0l121_qp
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/GoSam_POWHEG/p2_part21p &
   ! &art21_part25part25part21/helicity0d121h0l121_qp.f90
...
!---#[ subroutine brack_0:
   pure subroutine brack_0(ninjaA0, brack)
      ...
      use p2_part21part21_part25part25part21_abbrevd121h0_qp
      implicit none
      complex(ki), dimension(4), intent(in) :: ninjaA0
      complex(ki), dimension(3) :: acd121
      complex(ki), dimension (0:*), intent(inout) :: brack
      acd121(1)=dotproduct(ninjaA0,ninjaA0)
      acd121(2)=abb121(9)
      acd121(3)=acd121(2)*acd121(1)**2
      brack(ninjaidxt0)=acd121(3)
   end subroutine brack_0
!---#] subroutine brack_0:
!---#[ subroutine numerator_tmu:
   subroutine numerator_tmu(ncut, a, coeffs) &
   & bind(c, name="p2_part21part21_part25part25part21_d121h0_qp_ninja_tmu")
...
!---#] subroutine numerator_tmu:
end module     p2_part21part21_part25part25part21_d121h0l121_qp
