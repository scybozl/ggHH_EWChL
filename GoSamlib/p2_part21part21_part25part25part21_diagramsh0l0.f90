module     p2_part21part21_part25part25part21_diagramsh0l0
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/GoSam_POWHEG/p2_part21p &
   ! &art21_part25part25part21/helicity0diagramsl0.f90
...
!---#[ function amplitude:
   function amplitude()
      ...
      use p2_part21part21_part25part25part21_config, only: debug_lo_diagrams, &
        & use_sorted_sum
      use p2_part21part21_part25part25part21_accu, only: sorted_sum
      use p2_part21part21_part25part25part21_util, only: inspect_lo_diagram
      implicit none
...
!---#] function amplitude:
end module p2_part21part21_part25part25part21_diagramsh0l0
