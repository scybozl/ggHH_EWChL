...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      ...
      use p2_part21part21_part25part25part21_diagramsh0l0_qp, only: amplitudel0 => amplitude
      implicit none
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
      ...
      use p2_part21part21_part25part25part21_globalsl1_qp, only: amp0,perm, use_perm, epspow
