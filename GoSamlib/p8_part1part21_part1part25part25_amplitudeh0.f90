module    p8_part1part21_part1part25part25_amplitudeh0
   ...
   use p8_part1part21_part1part25part25_golem95h0
   use ninjago_module, only: ki_nin
   use p8_part1part21_part1part25part25_ninjah0
...
!---#[ function finite_renormalisation:
   function     finite_renormalisation(scale2) result(amp)
      ...
      use p8_part1part21_part1part25part25_diagramsh0l0, only: amplitudel0 => amplitude
      implicit none
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p8_part1part21_part1part25part25_abbrevd84h0, only: init_abbrevd84 => init_abbrev
      use p8_part1part21_part1part25part25_abbrevd86h0, only: init_abbrevd86 => init_abbrev
      use p8_part1part21_part1part25part25_abbrevd11h0, only: init_abbrevd11 => init_abbrev
      use p8_part1part21_part1part25part25_abbrevd88h0, only: init_abbrevd88 => init_abbrev
      use p8_part1part21_part1part25part25_diagramsh0l0, only: amplitudel0 => amplitude
      use p8_part1part21_part1part25part25_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p8_part1part21_part1part25part25_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p8_part1part21_part1part25part25_groups, only: contract_golem95
   use p8_part1part21_part1part25part25_ninjah0, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p8_part1part21_part1part25part25_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p8_part1part21_part1part25part25_groups, only: contract_golem95
   use p8_part1part21_part1part25part25_ninjah0, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p8_part1part21_part1part25part25_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p8_part1part21_part1part25part25_groups, only: contract_golem95
   use p8_part1part21_part1part25part25_ninjah0, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   real(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group2:
end module p8_part1part21_part1part25part25_amplitudeh0
