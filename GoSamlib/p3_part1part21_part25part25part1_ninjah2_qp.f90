!
module     p3_part1part21_part25part25part1_ninjah2_qp
...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part25part25part1_d84h2l1_qp, only: numerator_diagram84 =&
   &> numerator_ninja
   use p3_part1part21_part25part25part1_d84h2l121_qp, only: numerator_tmu_diagr&
   &am84 => numerator_tmu
   use p3_part1part21_part25part25part1_d84h2l131_qp, only: numerator_t3_diagram8&
   &4 => numerator_t3
   use p3_part1part21_part25part25part1_d84h2l132_qp, only: numerator_t2_diagram8&
   &4 => numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part25part25part1_kinematics_qp
   use p3_part1part21_part25part25part1_model_qp
   use p3_part1part21_part25part25part1_d11h2l1_qp, only: numerator_diagram11 =&
   &> numerator_ninja
   use p3_part1part21_part25part25part1_d11h2l121_qp, only: numerator_tmu_diagr&
   &am11 => numerator_tmu
   use p3_part1part21_part25part25part1_d11h2l131_qp, only: numerator_t3_diagram1&
   &1 => numerator_t3
   use p3_part1part21_part25part25part1_d11h2l132_qp, only: numerator_t2_diagram1&
   &1 => numerator_t2
   use p3_part1part21_part25part25part1_d86h2l1_qp, only: numerator_diagram86 =&
   &> numerator_ninja
   use p3_part1part21_part25part25part1_d86h2l121_qp, only: numerator_tmu_diagr&
   &am86 => numerator_tmu
   use p3_part1part21_part25part25part1_d86h2l131_qp, only: numerator_t3_diagram8&
   &6 => numerator_t3
   use p3_part1part21_part25part25part1_d86h2l132_qp, only: numerator_t2_diagram8&
   &6 => numerator_t2
   use p3_part1part21_part25part25part1_globalsl1_qp, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part25part25part1_kinematics_qp
   use p3_part1part21_part25part25part1_model_qp
   use p3_part1part21_part25part25part1_d88h2l1_qp, only: numerator_diagram88 =&
   &> numerator_ninja
   use p3_part1part21_part25part25part1_d88h2l121_qp, only: numerator_tmu_diagr&
   &am88 => numerator_tmu
   use p3_part1part21_part25part25part1_d88h2l131_qp, only: numerator_t3_diagram8&
   &8 => numerator_t3
   use p3_part1part21_part25part25part1_d88h2l132_qp, only: numerator_t2_diagram8&
   &8 => numerator_t2
   use p3_part1part21_part25part25part1_globalsl1_qp, only: epspow
...
!-----#] subroutine ninja_reduce_group2:
!---#] reduce groups with ninja:
end module p3_part1part21_part25part25part1_ninjah2_qp
