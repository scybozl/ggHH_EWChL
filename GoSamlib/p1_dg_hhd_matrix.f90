module     p1_dg_hhd_matrix
   ...
   use p1_dg_hhd_util_qp, only: square_qp => square
   ...
   use p1_dg_hhd_model_qp, only: Nf_qp => Nf, NC_qp => NC, sqrt2_qp => sqrt2, &
     & init_functions_qp => init_functions
   use p1_dg_hhd_color, only: TR, CA, CF, numcs, &
     & incolors, init_color
   use p1_dg_hhd_color_qp, only: TR_qp => TR, CA_qp => CA, CF_qp => CF, &
   ...
   use p1_dg_hhd_amplitudeh0_qp, only: samplitudeh0l1_qp => samplitude, &
   ...
   use p1_dg_hhd_amplitudeh1_qp, only: samplitudeh1l1_qp => samplitude, &
   ...
   use p1_dg_hhd_amplitudeh2_qp, only: samplitudeh2l1_qp => samplitude, &
   ...
   use p1_dg_hhd_amplitudeh3_qp, only: samplitudeh3l1_qp => samplitude, &
     &   finite_renormalisation3_qp => finite_renormalisation
   use p1_dg_hhd_dipoles, only: insertion_operator, insertion_operator_qed
   use p1_dg_hhd_dipoles_qp, only: insertion_operator_qp => insertion_operator, &
...
contains
   ...
   subroutine     samplitude(vecs, scale2, amp, prec, ok, h)
      use p1_dg_hhd_kinematics, only: adjust_kinematics, dotproduct
      use p1_dg_hhd_kinematics_qp, only: adjust_kinematics_qp => adjust_kinematics
      use p1_dg_hhd_model
      implicit none
