module     p8_part1part21_part1part25part25_diagramsh2l0
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/p8_part1part21_part1par &
   ! &t25part25/helicity2diagramsl0.f90
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(5)=mdlGC31*i_
      abb(4)=abb(4)-abb(5)
      abb(3)=1.0_ki/2.0_ki*abb(2)*mdlGC7*spbk3e2*abb(4)*abb(3)
      amplitude=c1*abb(3)
...
!---#] function amplitude:
end module p8_part1part21_part1part25part25_diagramsh2l0
