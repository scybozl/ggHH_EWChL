...
\begin{picture}(140,120)(-10,-10)
   ...
   \DashLine(77.7,64.7)(102.4,85.4){5} % part25-propagator
   \Text(100.5,83.1)[lb]{$h(k_{3})$}
   \DashLine(42.3,35.3)(17.6,14.6){5} % part25-propagator
   \Text(19.5,16.9)[rt]{$h(k_{4})$}
   \Vertex(77.7,35.3){3} % part6-anti6-part21 vertex
   \Vertex(77.7,64.7){3} % part6-anti6-part25 vertex
   \Vertex(42.3,35.3){3} % part6-anti6-part25 vertex
...
\begin{picture}(140,120)(-10,-10)
   ...
   \DashLine(77.7,35.3)(102.4,14.6){5} % part25-propagator
   \Text(104.3,12.3)[lt]{$h(k_{3})$}
   \DashLine(42.3,64.7)(17.6,85.4){5} % part25-propagator
   \Text(15.7,87.7)[rb]{$h(k_{4})$}
   \Vertex(77.7,64.7){3} % part6-anti6-part21 vertex
   \Vertex(77.7,35.3){3} % part6-anti6-part25 vertex
   \Vertex(42.3,64.7){3} % part6-anti6-part25 vertex
...
\begin{picture}(140,120)(-10,-10)
   ...
   \DashLine(38.8,50.0)(17.6,14.6){5} % part25-propagator
   \Text(20.1,16.2)[rt]{$h(k_{3})$}
   \DashLine(38.8,50.0)(17.6,85.4){5} % part25-propagator
   \Text(15.0,86.9)[rb]{$h(k_{4})$}
   \Vertex(81.2,35.9){3} % part6-anti6-part21 vertex
   \Vertex(81.2,64.1){3} % part6-anti6-part21 vertex
   \Vertex(38.8,50.0){3} % part6-anti6-part25-part25 vertex
...
\begin{picture}(140,120)(-10,-10)
   ...
   \DashLine(31.7,50.0)(17.6,14.6){5} % part25-propagator
   \Text(20.4,15.8)[rt]{$h(k_{3})$}
   \DashLine(31.7,50.0)(17.6,85.4){5} % part25-propagator
   \Text(14.8,86.5)[rb]{$h(k_{4})$}
   \Vertex(31.7,50.0){3} % part25-part25-part25 vertex
   \Vertex(88.3,35.9){3} % part6-anti6-part21 vertex
   \Vertex(88.3,64.1){3} % part6-anti6-part21 vertex
   \Vertex(60.0,50.0){3} % part6-anti6-part25 vertex
   \DashLine(60.0,50.0)(31.7,50.0){5} % part25-propagator
   \Text(45.9,47.0)[rt]{$h$}
