!
module     p1_part21part21_part25part25_ninjah0
...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p1_part21part21_part25part25_d13h0l1, only: numerator_diagram13 => numer&
   &ator_ninja
   use p1_part21part21_part25part25_d13h0l121, only: numerator_tmu_diagram13 =>&
   & numerator_tmu
   use p1_part21part21_part25part25_d13h0l131, only: numerator_t3_diagram13 => &
   &numerator_t3
   use p1_part21part21_part25part25_d13h0l132, only: numerator_t2_diagram13 => &
   &numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p1_part21part21_part25part25_kinematics
   use p1_part21part21_part25part25_model
   use p1_part21part21_part25part25_d2h0l1, only: numerator_diagram2 => numerat&
   &or_ninja
   use p1_part21part21_part25part25_d2h0l121, only: numerator_tmu_diagram2 => n&
   &umerator_tmu
   use p1_part21part21_part25part25_d2h0l131, only: numerator_t3_diagram2 => nu&
   &merator_t3
   use p1_part21part21_part25part25_d2h0l132, only: numerator_t2_diagram2 => nu&
   &merator_t2
   use p1_part21part21_part25part25_d7h0l1, only: numerator_diagram7 => numerat&
   &or_ninja
   use p1_part21part21_part25part25_d7h0l121, only: numerator_tmu_diagram7 => n&
   &umerator_tmu
   use p1_part21part21_part25part25_d7h0l131, only: numerator_t3_diagram7 => nu&
   &merator_t3
   use p1_part21part21_part25part25_d7h0l132, only: numerator_t2_diagram7 => nu&
   &merator_t2
   use p1_part21part21_part25part25_d11h0l1, only: numerator_diagram11 => numer&
   &ator_ninja
   use p1_part21part21_part25part25_d11h0l121, only: numerator_tmu_diagram11 =>&
   & numerator_tmu
   use p1_part21part21_part25part25_d11h0l131, only: numerator_t3_diagram11 => &
   &numerator_t3
   use p1_part21part21_part25part25_d11h0l132, only: numerator_t2_diagram11 => &
   &numerator_t2
   use p1_part21part21_part25part25_globalsl1, only: epspow
...
subroutine     ninja_reduce_group2(scale2,tot,totr,ok)
   ...
   use p1_part21part21_part25part25_kinematics
   use p1_part21part21_part25part25_model
   use p1_part21part21_part25part25_d9h0l1, only: numerator_diagram9 => numerat&
   &or_ninja
   use p1_part21part21_part25part25_d9h0l121, only: numerator_tmu_diagram9 => n&
   &umerator_tmu
   use p1_part21part21_part25part25_d9h0l131, only: numerator_t3_diagram9 => nu&
   &merator_t3
   use p1_part21part21_part25part25_d9h0l132, only: numerator_t2_diagram9 => nu&
   &merator_t2
   use p1_part21part21_part25part25_globalsl1, only: epspow
...
!-----#] subroutine ninja_reduce_group2:
!---#] reduce groups with ninja:
end module p1_part21part21_part25part25_ninjah0
