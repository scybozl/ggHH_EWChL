...
colorfile.write('module     p1_part21part21_part25part25_color\n')
colorfile.write('   ! file: '+str(os.getcwd())+'color.f90 \n')
colorfile.write('   ! generator: buildcolor.py\n')
colorfile.write('   use p1_part21part21_part25part25_config, only: ki\n')
colorfile.write('   use p1_part21part21_part25part25_model, only: NC, Nf\n')
...
colorfile.write('end module p1_part21part21_part25part25_color\n')
