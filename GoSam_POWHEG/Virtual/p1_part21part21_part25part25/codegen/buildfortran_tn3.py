...
f90file.write('module     p1_part21part21_part25part25_'+diag_name[:-1]+'31\n')
...
f90file.write('   & bind(c, name="p1_part21part21_part25part25_d{0}h{1}_ninja_t3")\n'.format(diag,heli) )
...
f90file.write('end module     p1_part21part21_part25part25_'+diag_name[:-1]+'31\n')
f90file.close()
