...
f90file.write('module     p3_part1part21_part25part25part1_'+diag_name[:-1]+'21\n')
...
f90file.write('   use p3_part1part21_part25part25part1_util, only: cond_t, d => metric_tensor \n')
f90file.write('\n')
...
f90file.write('   & bind(c, name="p3_part1part21_part25part25part1_d{0}h{1}_ninja_tmu")\n'.format(diag,heli) )
...
f90file.write('end module     p3_part1part21_part25part25part1_'+diag_name[:-1]+'21\n')
f90file.close()
