...
abbfile.write('module     p3_part1part21_part25part25part1_abbrevd'+diag+'h'+heli+'\n')
abbfile.write('   use p3_part1part21_part25part25part1_config, only: ki\n')
abbfile.write('   use p3_part1part21_part25part25part1_kinematics, only: epstensor\n')
abbfile.write('   use p3_part1part21_part25part25part1_globals'+'h'+heli+'\n')
...
abbfile.write('      use p3_part1part21_part25part25part1_config, only: deltaOS, &\n')
abbfile.write('     &    logfile, debug_nlo_diagrams\n')
abbfile.write('      use p3_part1part21_part25part25part1_kinematics\n')
abbfile.write('      use p3_part1part21_part25part25part1_model\n')
abbfile.write('      use p3_part1part21_part25part25part1_color, only: TR\n')
abbfile.write('      use p3_part1part21_part25part25part1_globalsl1, only: epspow\n')
abbfile.write('      implicit none\n')
abbfile.write('\n')
abb_chunks = []
line_counter = 0
...
abbfile.write('   end subroutine\n')
abbfile.write('end module p3_part1part21_part25part25part1_abbrevd'+diag+'h'+heli+'\n')


f90file.write('module     p3_part1part21_part25part25part1_'+diag_name+'\n')
f90file.write('   ! file: '+str(os.getcwd())+diag_name+'.f90 \n')
f90file.write('   ! generator: buildfortran.py \n')
f90file.write('   use p3_part1part21_part25part25part1_config, only: ki\n')
f90file.write('   use p3_part1part21_part25part25part1_util, only: cond\n')
f90file.write('\n')
...
f90file.write('      use p3_part1part21_part25part25part1_model\n')
f90file.write('      use p3_part1part21_part25part25part1_kinematics\n')
f90file.write('      use p3_part1part21_part25part25part1_color\n')
f90file.write('      use p3_part1part21_part25part25part1_abbrevd'+diag+'h'+heli+'\n')
f90file.write('      implicit none\n')
...
f90file.write('      use p3_part1part21_part25part25part1_globalsl1, only: epspow\n')
f90file.write('      use p3_part1part21_part25part25part1_kinematics\n')
f90file.write('      use p3_part1part21_part25part25part1_abbrevd'+diag+'h'+heli+'\n')
f90file.write('      implicit none\n')
f90file.write('\n')
...
f90file.write('   & bind(c, name="p3_part1part21_part25part25part1_'+diag_name+'_ninja")\n')
...
f90file.write('   !------#] subroutine numerator_ninja:\n')
f90file.write('!---#] numerator interfaces:\n')
f90file.write('end module p3_part1part21_part25part25part1_'+diag_name+'\n')
txtfile.close()
abbfile.close()
f90file.close()
