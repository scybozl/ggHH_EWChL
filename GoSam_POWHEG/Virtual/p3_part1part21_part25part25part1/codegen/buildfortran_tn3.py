...
f90file.write('module     p3_part1part21_part25part25part1_'+diag_name[:-1]+'31\n')
...
f90file.write('   & bind(c, name="p3_part1part21_part25part25part1_d{0}h{1}_ninja_t3")\n'.format(diag,heli) )
...
f90file.write('end module     p3_part1part21_part25part25part1_'+diag_name[:-1]+'31\n')
f90file.close()
