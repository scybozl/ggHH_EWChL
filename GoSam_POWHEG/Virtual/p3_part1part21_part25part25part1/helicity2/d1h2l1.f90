module     p3_part1part21_part25part25part1_d1h2l1
   ! file: /draco/ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/GoSam_POWHEG/Virtual/p3 &
   ! &_part1part21_part25part25part1/helicity2d1h2l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc1(11)=Qspvak1k5*acc1(11)
      acc1(12)=Qspvae2k5*acc1(8)
      acc1(13)=Qspvak1e2*acc1(3)
      acc1(14)=Qspvak2k5*acc1(2)
      acc1(15)=Qspvak1k2*acc1(5)
      acc1(16)=QspQ*acc1(6)
...
!---#[ numerator interfaces:
   ...
   & bind(c, name="p3_part1part21_part25part25part1_d1h2l1_ninja")
   ...
   !------#] subroutine numerator_ninja:
!---#] numerator interfaces:
end module p3_part1part21_part25part25part1_d1h2l1
