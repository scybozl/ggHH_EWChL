program test
   use p3_part1part21_part25part25part1_config, only: ki, logfile, nlo_prefactors
   use p3_part1part21_part25part25part1_kinematics, only: dotproduct, boost_to_cms
   use p3_part1part21_part25part25part1_model, only: parse
   use p3_part1part21_part25part25part1_matrix, only: samplitude, &
     & initgolem, exitgolem, ir_subtraction
   use p3_part1part21_part25part25part1_color, only: numcs, CA
   use p3_part1part21_part25part25part1_rambo, only: ramb
...
subroutine  print_parameters(scale2)
   use p3_part1part21_part25part25part1_config, only: renormalisation, &
