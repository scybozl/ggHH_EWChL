...
subroutine     ninja_reduce_group0(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part25part25part1_d7h0l1, only: numerator_diagram7 => num&
   &erator_ninja
   use p3_part1part21_part25part25part1_d7h0l121, only: numerator_tmu_diagram7 &
   &=> numerator_tmu
   use p3_part1part21_part25part25part1_d7h0l131, only: numerator_t3_diagram7 =&
   &> numerator_t3
   use p3_part1part21_part25part25part1_d7h0l132, only: numerator_t2_diagram7 =&
   &> numerator_t2
...
subroutine     ninja_reduce_group1(scale2,tot,totr,ok)
   ...
   use p3_part1part21_part25part25part1_kinematics
   use p3_part1part21_part25part25part1_model
   use p3_part1part21_part25part25part1_d1h0l1, only: numerator_diagram1 => num&
   &erator_ninja
   use p3_part1part21_part25part25part1_d1h0l121, only: numerator_tmu_diagram1 &
   &=> numerator_tmu
   use p3_part1part21_part25part25part1_d1h0l131, only: numerator_t3_diagram1 =&
   &> numerator_t3
   use p3_part1part21_part25part25part1_d1h0l132, only: numerator_t2_diagram1 =&
   &> numerator_t2
   use p3_part1part21_part25part25part1_d9h0l1, only: numerator_diagram9 => num&
   &erator_ninja
   use p3_part1part21_part25part25part1_d9h0l121, only: numerator_tmu_diagram9 &
   &=> numerator_tmu
   use p3_part1part21_part25part25part1_d9h0l131, only: numerator_t3_diagram9 =&
   &> numerator_t3
   use p3_part1part21_part25part25part1_d9h0l132, only: numerator_t2_diagram9 =&
   &> numerator_t2
   use p3_part1part21_part25part25part1_globalsl1, only: epspow
