module    p3_part1part21_part25part25part1_amplitudeh0
   ...
   use p3_part1part21_part25part25part1_golem95h0
   use ninjago_module, only: ki_nin
   use p3_part1part21_part25part25part1_ninjah0
...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,the_col0,opt_perm)
     ...
     & only: init_lo, rat2
      use p3_part1part21_part25part25part1_abbrevd7h0, only: init_abbrevd7 => init_abbrev
      use p3_part1part21_part25part25part1_abbrevd1h0, only: init_abbrevd1 => init_abbrev
      use p3_part1part21_part25part25part1_abbrevd9h0, only: init_abbrevd9 => init_abbrev
      use p3_part1part21_part25part25part1_abbrevd11h0, only: init_abbrevd11 => init_abbrev
      use p3_part1part21_part25part25part1_groups
      implicit none
      real(ki), intent(in) :: scale2
...
subroutine     evaluate_group0(scale2,samplitude,ok)
   ...
   use p3_part1part21_part25part25part1_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p3_part1part21_part25part25part1_groups, only: contract_golem95
   use p3_part1part21_part25part25part1_ninjah0, only: ninja_reduce => ninja_reduce_group0
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
...
subroutine     evaluate_group1(scale2,samplitude,ok)
   ...
   use p3_part1part21_part25part25part1_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p3_part1part21_part25part25part1_groups, only: contract_golem95
   use p3_part1part21_part25part25part1_ninjah0, only: ninja_reduce => ninja_reduce_group1
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
subroutine     evaluate_group2(scale2,samplitude,ok)
   ...
   use p3_part1part21_part25part25part1_golem95h0, only: reconstruct_golem95 => reconstruct_group
   use p3_part1part21_part25part25part1_groups, only: contract_golem95
   use p3_part1part21_part25part25part1_ninjah0, only: ninja_reduce => ninja_reduce_group2
   implicit none
   real(ki), intent(in) :: scale2
   logical, intent(out) :: ok
   complex(ki), dimension(-2:0), intent(out) :: samplitude
...
!---#] subroutine evaluate_group2:
end module p3_part1part21_part25part25part1_amplitudeh0
