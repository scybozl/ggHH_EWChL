program test
   use pb_part21part21_part25part25_config, only: ki, logfile, nlo_prefactors
   use pb_part21part21_part25part25_kinematics, only: dotproduct, boost_to_cms
   use pb_part21part21_part25part25_model, only: parse
   use pb_part21part21_part25part25_matrix, only: samplitude, &
     & initgolem, exitgolem, ir_subtraction
   use pb_part21part21_part25part25_color, only: numcs, CA
   use pb_part21part21_part25part25_rambo, only: ramb
...
subroutine  print_parameters(scale2)
   use pb_part21part21_part25part25_config, only: renormalisation, &
