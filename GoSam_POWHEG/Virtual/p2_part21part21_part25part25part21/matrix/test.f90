program test
   use p2_part21part21_part25part25part21_config, only: ki, logfile, nlo_prefactors
   use p2_part21part21_part25part25part21_kinematics, only: dotproduct, boost_to_cms
   use p2_part21part21_part25part25part21_model, only: parse
   use p2_part21part21_part25part25part21_matrix, only: samplitude, &
     & initgolem, exitgolem, ir_subtraction
   use p2_part21part21_part25part25part21_color, only: numcs, CA
   use p2_part21part21_part25part25part21_rambo, only: ramb
...
subroutine  print_parameters(scale2)
   use p2_part21part21_part25part25part21_config, only: renormalisation, &
