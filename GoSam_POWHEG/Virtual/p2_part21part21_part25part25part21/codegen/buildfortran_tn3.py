...
f90file.write('module     p2_part21part21_part25part25part21_'+diag_name[:-1]+'31\n')
...
f90file.write('   & bind(c, name="p2_part21part21_part25part25part21_d{0}h{1}_ninja_t3")\n'.format(diag,heli) )
...
f90file.write('end module     p2_part21part21_part25part25part21_'+diag_name[:-1]+'31\n')
f90file.close()
