...
modelfile.write('module     p2_part21part21_part25part25part21_model\n')
modelfile.write('   ! Model parameters for the model: /ptmp/lscyboz/POWHEG-BOX-V2/ggHH_EWChL/GoSam_POWHEG/Virtual/model/model\n')
modelfile.write('   use p2_part21part21_part25part25part21_config, only: ki')
modelfile.write(', &\n')
...
modelfile.write('   complex(ki) :: gauge5z = (       0.000000000000000_ki,        0.000000000000000_ki)\n')
modelfile.write('   real(ki) :: mdlaEWM1 =      127.900000000000006_ki\n')
modelfile.write('   real(ki) :: mdlaS =        0.079577470000000_ki\n')
...
modelfile.write('   character(len=name_length), dimension(36) :: names = (/&\n')
...
modelfile.write("   write(unit,'(A1,1x,A11,\"(\",G23.16,G23.16,\")\")') \"#\", \"gauge5z= \", gauge5z\n")
...
modelfile.write("end module p2_part21part21_part25part25part21_model\n")
