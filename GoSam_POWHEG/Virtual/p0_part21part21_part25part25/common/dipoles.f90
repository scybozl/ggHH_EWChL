module     p0_part21part21_part25part25_dipoles
   use p0_part21part21_part25part25_config, only: ki
   use p0_part21part21_part25part25_color, only: gammaF, gammaA, &
       & CF, CA, numcs, KF, KA, &
       & T1T2
   use p0_part21part21_part25part25_kinematics, only: num_legs, dotproduct, &
       lambda
   implicit none
...
end module p0_part21part21_part25part25_dipoles
